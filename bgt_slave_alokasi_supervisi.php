...
switch($proses)
{
	...
	case'getPreview':
          if($thnBudget=='')
          {
           ...
           //$sCek="select sum(jumlahhk) as totalJmlhHk from ".$dbname.".bgt_hkperkegiatan_vw where tahunbudget='".$thnBudget."' and substring(kodeorg,1,4)='".$_SESSION['empl']['lokasitugas']."'";
            ...
            $sCek2="SELECT distinct a.kodeorg,a.kegiatan,b.namakegiatan FROM " . $dbname . ".bgt_budget  a
	...
	break;
       ...
       $sDel="delete from ".$dbname.".bgt_budget where tahunbudget='".$thnBudget."' and kodeorg='".$kdBlok."' and tipebudget='ESTATE' and noakun='".$noakn."' and kegiatan='".$kgtn."' and kodebudget='SUPERVISI'";
       if(mysql_query($sDel))
       {    
            ...
            value ('".$thnBudget."','".$kdBlok."','ESTATE','SUPERVISI','".$kgtn."','".$noakn."','".$volKeg."','".$satKeg."','".$rpsuperVisi."','".$rotasi."','".$_SESSION['standard']['userid']."','".$hkSprvisi."','hk')";
