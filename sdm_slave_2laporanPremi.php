...
//echo($tanggalMulai." ".$periode." ".$kdOrg); exit;
...
// building array: dzArr (main data) =========================================================================
    ...
    $sPeople="SELECT b.karyawanid as karyawanid, b.namakaryawan as namakaryawan, b.kodejabatan as kodejabatan,b.tipekaryawan,b.subbagian 
			  ...
			  WHERE (b.tanggalkeluar != '0000-00-00' or b.tanggalkeluar != '')  ".$where2." 
...
//		if($dzArr[$res['karyawanid']][nm]=='')$dzArr[$res['karyawanid']][nm]=$res['namakaryawan']." *";
	  ...
	  /*
		...
		*/
		 $sPeople="SELECT b.namakaryawan, b.kodejabatan, a.karyawanid as karyawanid, sum(a.insentif) as insentif 
			  FROM ".$dbname.".kebun_kehadiran_new_vw a
			  LEFT JOIN ".$dbname.".datakaryawan b on a.karyawanid = b.karyawanid
			  WHERE a.tanggal>='".$tanggalMulai."' and a.tanggal<='".$tanggalSampai."' ".$where2." 
			  GROUP BY a.karyawanid ORDER BY a.karyawanid";
        //echo $sPeople;
...
// preview header =========================================================================
	...
	<td>Hasil Kerja Penen</td>
	<td>Norma</td>
	<td>Premi Panen</td>
	<td>Insentif Perawatan</td>
	<td>Traksi</td>
	<td>Pengawasan</td>
        <td>Kemandoran Panen</td>
	<td>Penalty PNN</td>
...
// excel header =========================================================================
	...
	<td bgcolor=#DEDEDE align=center>Hasil Kerja Penen</td>
	<td bgcolor=#DEDEDE align=center>Norma</td>
	<td bgcolor=#DEDEDE align=center>Premi Panen</td>
	<td bgcolor=#DEDEDE align=center>Insentif Perawatan</td>
	<td bgcolor=#DEDEDE align=center>Traksi</td>
	<td bgcolor=#DEDEDE align=center>Pengawasan</td>
	<td bgcolor=#DEDEDE align=center>Penalty PNN</td>
