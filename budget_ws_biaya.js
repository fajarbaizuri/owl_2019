...
//                    showById('printPanel');
                    if(con.responseText==''){
                        alert('HK Efektif untuk tahun budget belum tersedia.\nSilakan mengisinya terlebih dahulu');
                    }else
                    {
                        document.getElementById('hkefektif0').value=con.responseText;
...
function bersihkan(tab)
{
    ...
    if(tab==2){
        ...
        if(kodebudget2V==''){
			...
			//perubahan indra
			document.getElementById('kodebarang2').value=kodebudget2V.slice(2);
    //        document.getElementById('kodebarang1').value=Right(kodebudget1V,3);
        ...
        if (con.readyState == 4) {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    if(con.responseText==''){
                        document.getElementById('kodebudget0').value='';
                        alert('Data upah untuk tahun budget dan organisasi belum tersedia. Atau belum diposting.\nSilakan mengisinya kemudian mempostingnya terlebih dahulu');
                    }else
                    {
        ...
        if (con.readyState == 4) {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    if(con.responseText==''){
                    document.getElementById('jumlah1').value='';
                    alert('Data kode bengkel belum memiliki Regional.\nSilakan mengisinya terlebih dahulu');
                }else
                {
        ...
        if (con.readyState == 4) {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    if(con.responseText==''){
                        document.getElementById('jumlah1').value='';
                        alert('Data barang belum memiliki Harga. Atau belum diposting.\nSilakan mengisinya kemudian mempostingnya terlebih dahulu');
                    }else{
...
function simpan1()
{
    ...
    if(jumlah1V==''){
        alert('Jumlah is empty.\nUntuk dapat mengisi Jumlah, silakan mengisi Kode Budget dan Kode Barang terlebih dahulu.');
        return;
    }
...
function simpan3()
{
    ...
    if(kodebudget3V==''){
        alert('Silakan mengisi Kode Budget terlebih dahulu.');
        return;
    }
    if(kodeakun3V==''){
        alert('Silakan mengisi Kode Akun terlebih dahulu.');
        return;
    }
    if(totalbiaya3V==''){
        alert('Silakan mengisi Biaya terlebih dahulu.');
        return;
    }
...
function findBrg(tab)
{
	...
	kodebudget2 =document.getElementById('kodebudget2');
        kodebudget2V	=kodebudget2.options[kodebudget2.selectedIndex].value;
        kodebudget2V=kodebudget2V.slice(2);	
	//tutup perubahan indra	
    ...
    else
    {
        ...
        if(tab=='2'){//perubahan indra
            param='tab=2&txtfind='+txt+'&awalan='+kodebudget2V;//penambahan script +kodebudget2V pada baris ini
        }
