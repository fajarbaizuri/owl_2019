...
//	}
	...
	$sql="select a.tanggal,a.kodevhc,a.downtime,posting,b.* from ".$dbname.".vhc_penggantianht a left join ".$dbname.".vhc_penggantiandt b on a.notransaksi=b.notransaksi 
