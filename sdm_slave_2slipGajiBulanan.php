...
$sSlip="select distinct a.*,b.tipekaryawan,b.statuspajak,b.tanggalmasuk,b.nik,b.namakaryawan,b.bagian,c.namajabatan,d.nama from 
       ...
       left join ".$dbname.".sdm_5departemen d on b.bagian=d.kode where ".$where." ".$dtTipe." order by b.subbagian,b.namakaryawan";
// echo $sSlip;
//exit("Error".$sSlip);
      ...
      $arrNmKomMin[$rKomp['id']]=$rKomp['name'];
                ...
                <tr>
                        ...
                        <td bgcolor=#DEDEDE align=center rowspan='2'>".$_SESSION['lang']['unit']."/".$_SESSION['lang']['bagian']."</td>
                         <td bgcolor=#DEDEDE align=center rowspan='2'>Mandor</td>    
...
if($rCek>0)
{
        ...
        $peng2=36;
            ...
            {			
                        ...
                        $stream.="<tr><td colspan=10 align=right>".$_SESSION['lang']['total']."</td><td>";
