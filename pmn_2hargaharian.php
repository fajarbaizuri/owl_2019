...
$sBrng="select distinct kodebarang,namabarang from ".$dbname.".log_5masterbarang where kodebarang='40000001' order by namabarang asc";
...
OPEN_BOX('',"<b>Harga Harian</b><br>");
$frm[0].="<div>
<fieldset style='float: left;'>
<legend><b>Harga per Pasar</b></legend>";
$frm[0].="<table cellspacing=1 border=0 >
<tr><td><label>".$_SESSION['lang']['pasar']."</label></td><td><select id=psrId name=periode style='width:150px'>".$optGoldar."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['periode']."</label></td><td><select id=periodePsr name=periode style='width:150px'>".$optPeriode."</select></td></tr>
...
$frm[1].="<div>
<fieldset style='float: left;'>
<legend><b>Perbandingan Harga</b></legend>";
$frm[1].="<table cellspacing=1 border=0 >
<tr><td><label>".$_SESSION['lang']['pasar']."</label></td><td><select id=psrId2 name=periode style='width:150px'>".$optpasar."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['komoditi']."</label></td><td><select id=komodoti name=periode style='width:150px'>".$optBrg."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['periode']."</label></td><td><select id=periodePsr2 name=periode style='width:150px'>".$optPeriode."</select></td></tr>
<tr height=20><td colspan=2>&nbsp;</td></tr>
<tr height=20><td colspan=2>&nbsp;</td></tr>
<tr><td colspan=2>
...
//========================
$hfrm[0]="Harga per Pasar";
$hfrm[1]="Perbandingan Harga";
