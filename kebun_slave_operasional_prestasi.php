...
switch($proses) {
    case 'add':
		$cols = array(
			'kodekegiatan','kodeorg','hasilkerja','jumlahhk',
			'notransaksi','tahuntanam','norma','statusblok','pekerjaanpremi',
			'penalti1','penalti2','penalti3','penalti4','penalti5','nik',
			'upahkerja','umr','upahpremi'
		);
		$data = $param;
		unset($data['numRow']);
		...
		$data['upahkerja'] = 0;$data['umr'] = 0;$data['upahpremi'] = 0;
		...
		unset($data['upahkerja']);unset($data['umr']);unset($data['upahpremi']);
