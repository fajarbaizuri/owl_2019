...
$sKodeOrg="select distinct jlhjjg, jlhkg, tahunbudget,thntnm from ".$dbname.".bgt_produksi_afdeling where  
    ".$where."  order by tahunbudget asc";
//echo $sKodeOrg;
            ...
            $awal=0;
                 ...
                 foreach($dtNoakun as $barisNoakun)
                 {
                      ...
                      if($brs==1) 
                      {
                        ...
                        if(substr($barisNoakun,0,3)=='122' or substr($barisNoakun,0,3)=='123' or substr($barisNoakun,0,3)=='124' or substr($barisNoakun,0,3)=='125')//TBM
                        {
...
//                            @$hasilBagi[$barisNoakun]=$totRupiah[$thnBudget][$barisNoakun]/$ttlLuastm;
                       if(substr($barisNoakun,0,3)=='122' or substr($barisNoakun,0,3)=='123' or substr($barisNoakun,0,3)=='124' or substr($barisNoakun,0,3)=='125')//TBM
                        ...
                        foreach($dtThnBudget as $brsThnBudget)
                        {
                            if(substr($barisNoakun,0,3)=='122' or substr($barisNoakun,0,3)=='123' or substr($barisNoakun,0,3)=='124' or substr($barisNoakun,0,3)=='125'){
                                @$hasilBagi2[$brsThnBudget]=$lstRupiah[$thnBudget][$brsThnBudget][$barisNoakun]/$dtJmlhLuastbm[$thnBudget][$brsThnBudget];                               
                                $totalRptbm[$brsThnBudget]+=$lstRupiah[$thnBudget][$brsThnBudget][$barisNoakun];
                                $totalbagitbm[$brsThnBudget]+=$hasilBagi2[$brsThnBudget];
