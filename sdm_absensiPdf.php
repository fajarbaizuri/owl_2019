...
//			$this->Cell(80,5,$_SESSION['standard']['username'],'',1,'L');
	...
	$pdf->SetY(55);
	$pdf->Cell(190,5,$_SESSION['lang']['list']." ".$_SESSION['lang']['absensi'],0,1,'C');	
	$pdf->Ln();	
	...
	$pdf->Cell(35,5,$_SESSION['lang']['absensi'],1,0,'C',1);
	...
	$pdf->SetFont('Arial','',9);
		...
		while($res=mysql_fetch_assoc($re))
		{
			...
			$pdf->Cell(20,5,$res['shift'],1,0,'C',1);
			$pdf->Cell(35,5,$rShift['keterangan'],1,0,'L',1);
			$pdf->Cell(20,5,$res['jam'],1,0,'C',1);
			$pdf->Cell(55,5,$res['penjelasan'],1,1,'L',1);	
		}
