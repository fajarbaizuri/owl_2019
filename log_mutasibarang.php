...
$str="select kodeorganisasi,namaorganisasi from ".$dbname.".organisasi where tipe='GUDANG' and kodeorganisasi not in ('SENE10', 'SKNE10', 'SOGE30') order by namaorganisasi";
$res=mysql_query($str);
$optsloc="<option value=''></option>";
while($bar=mysql_fetch_object($res))
{
