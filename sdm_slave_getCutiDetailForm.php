...
echo"<fieldset><legend>".$_SESSION['lang']['form']."</legend>
    <table>
	 ...
	 ".$_SESSION['lang']['namakaryawan']."</td><td><input type=text class=myinputtext id=namakaryawan disabled value='".$namakaryawan."' size=25>
	 </td>".$_SESSION['lang']['tangalcuti']."</td><td><input type=text class=myinputtext id=dariJ onmouseover=setCalendar(this) onkeypress=\"return false;\" size=15>
	 ...
	 <tr>
	 <td>
	 ".$_SESSION['lang']['diambil']."</td><td><input type=text class=myinputtextnumber id=diambilJ  size=25 onkeypress=\"return angka_doang(event);\"  size=3 maxlength=2>
