...
if($proses=='excel')
{
    ...
    $tab.="<tr class=rowcontent><td colspan=3>Total Gaji</td><td align=right>".number_format($totGaji,0)."</td>";
...
class PDF extends FPDF
        {
            function Header() {
				...
				$this->Cell($width,$height,strtoupper("Daftar Remise I"),'',0,'C');
				$this->Ln();
				$this->Cell($width,$height,strtoupper($_SESSION['lang']['tanggal'])." :".tanggalnormal($tglDari)." s.d. ".tanggalnormal($tglSmp),'',0,'C');
				$this->Ln();
				$this->Ln();
