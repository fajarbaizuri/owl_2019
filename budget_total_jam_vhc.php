...
<tr><td>Total HM-KM/Tahun</td><td><input type="text" id="totJamThn" class="myinputtextnumber" onkeypress="return angka_doang(event);" style="width:150px"  /></td></tr>
...
echo"<td>".$_SESSION['lang']['unit']." <select id=kdUnitHead onchange=loadData()>".$optUnit."</select></td>";
echo"</tr></table>";
