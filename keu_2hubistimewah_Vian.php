...
echo open_body();
?>
<script language=javascript1.2 src="js/keu_hubistemewa_ian.js"></script>
...
<legend><b><?php echo "Hubungan Istimewa"?></b></legend>
<table cellspacing="1" border="0" >
<tr><td><label><?php echo $_SESSION['lang']['pt']?></label></td><td>
<select id=pt style='width:200px;'  onchange=ambilAnak(this.options[this.selectedIndex].value,1)>
...
<tr><td><label><?php echo $_SESSION['lang']['pt']." H/I"?></label></td><td>
<select id=pt2 style='width:200px;'  onchange=ambilAnak(this.options[this.selectedIndex].value,2)>
<?php echo $optpt; ?></select></tr>
<tr><td><label><?php echo $_SESSION['lang']['unit']." H/I"?></label></td><td><select id=gudang2 style='width:200px;' ><?php echo $optgudang; ?></select></td></tr>
...
<tr height="20"><td colspan="2"> <button class=mybutton onclick="getLapHubIS()"><?php echo $_SESSION['lang']['proses'] ?></button></td></tr>
...
*/
echo"<span id=printPanel style='display:none;'>
     <img onclick=jurnalv1KeExcel(event,'keu_laporanhubisvIAN_Excel.php') src=images/excel.jpg class=resicon title='MS.Excel'> 
	 </span>    
	 <div style='width:100%;height:359px;overflow:scroll;'>
