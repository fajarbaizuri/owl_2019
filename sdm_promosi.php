...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING')
{
  $str=" select karyawanid,namakaryawan,bagian from ".$dbname.".datakaryawan
       where tanggalkeluar='0000-00-00' and tipekaryawan<4 order by namakaryawan";	
}
else
{
 $str=" select karyawanid,namakaryawan,bagian from ".$dbname.".datakaryawan
...
{
	$optkar.="<option value='".$bar->karyawanid."'>".$bar->namakaryawan." -[".$bar->bagian."]</option>";
}
//=================
...
$frm[0].="
     ...
     <table>
	  ...
	  <tr> 	 
 	  ...
 	  <tr> 	 
		 <td>".$_SESSION['lang']['paragraf1']."<br>(Kosong = default)</td><td><textarea cols=60 rows=2 id=paragraf1></textarea></td>
	  </tr>         
          </table>
	 <table>
	   <tr>
	 ...
	 <table>    
 	  <tr> 	 
		 <td>".$_SESSION['lang']['paragraf2']."<br>(Kosong = default)</td><td><textarea cols=60 rows=3 id=paragraf2></textarea></td>
	  </tr>               
	 <tr>
	 <td>
