...
$optKont = makeOption($dbname,'log_5supplier','supplierid,namasupplier',null,'0',true);
$optBlok = makeOption($dbname,'organisasi','kodeorganisasi,namaorganisasi',"tipe='BLOK'",'0',true);
$optAfd = makeOption($dbname,'organisasi','kodeorganisasi,namaorganisasi',"tipe='AFDELING' and induk in(select kodeorganisasi from ".$dbname.".organisasi where tipe='KEBUN')",'0',true);


$optKeg[''] = $_SESSION['lang']['all'];
$optKont[''] = $_SESSION['lang']['all'];
$optAfd[''] = $_SESSION['lang']['all'];
$optBlok[''] = $_SESSION['lang']['all'];
...
Kegiatan ".makeElement('filterKeg','select','',array(),$optKeg)."
	<br />Kontraktor ".makeElement('filterKontraktor','select','',array(),$optKont)."
	afdeling ".makeElement('filterAfd','select','',array(),$optAfd)."
	Blok ".makeElement('filterBlok','select','',array(),$optBlok)."
