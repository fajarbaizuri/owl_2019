...
# Get Data
$where = "`detail`=1";
$optAkun = makeOption($dbname,'keu_5akun','noakun,namaakun',$where,'2');
...
$els[] = array(
  ...
  makeElement('kodekegiatan','text','',array('style'=>'width:60px','maxlength'=>'10'))
);
$els[] = array(
...
# Fields
$fieldStr = '##kodeorg##kodekegiatan##namakegiatan##kelompok##satuan##noakun';
$fieldArr = explode("##",substr($fieldStr,2,strlen($fieldStr)-2));

# Button
$els['btn'] = array(
  genFormBtn($fieldStr,
    'setup_kegiatan',"##kodekegiatan##kodeorg#")
);

# Generate Field
echo genElTitle('Kegiatan',$els);
echo "</div>";
#=======End Form============
...
$whereKEG=" pilih<>4 ";
# Extract Data
$query = "select kodeorg,kodekegiatan,namakegiatan,kelompok,satuan,noakun from ".$dbname.".".$table." where pilih<>'4'";
...
$tables .= "<img src='images/pdf.jpg' title='PDF Format'
  style='width:20px;height:20px;cursor:pointer' onclick=\"masterPDF('".$table."','*','".$whereKEG."','setup_slave_kegiatan_pdf',event)\">&nbsp;";
