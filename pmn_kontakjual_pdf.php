...
class PDF extends FPDF
{
	...
	global $nama;
		...
		$this->SetX(50);
		$this->Cell(35,5,strtoupper($_SESSION['lang']['kontrakJual']." ".$rBrg['namabarang']),0,1,'L');
		$this->SetFont('Arial','','10');
		$this->SetX(85);
		$this->Cell(35,5,$_SESSION['lang']['nourut'].": ".$noKontrak,0,1,'L');
		//$this->SetX(80);
//		$this->Cell(35,5,$_SESSION['lang']['tglKontrak'].": ".$tlgKontrk,0,1,'L');
		$this->Ln();
...
/*	$pdf->Cell(35,5,$_SESSION['lang']['nmcust']." : ".$rCust['namacustomer'],0,1,'L');
	...
	$pdf->Cell(2,5,':','',0,'L');
	$pdf->Cell(100,5,"Rp. ".number_format($rKntrk['hargasatuan'],2),'',0,'L');
	$pdf->Ln();
	
	$pdf->Cell(35,5,$_SESSION['lang']['total']."(Rp)",'',0,'L');
	$pdf->Cell(2,5,':','',0,'L');
	$pdf->Cell(100,5,"Rp. ".number_format($rKntrk['total'],2),'',0,'L');
	$pdf->Ln();
