...
class PDF extends FPDF
{
	...
	global $an;
	 ...
	 //  $this->SetMargins(15,10,0);
		...
		$this->Cell(60,3,$alamatpt,0,1,'L');	
		$this->SetX(55); 			
		$this->Cell(60,3,"Telp. : ".$telp,0,1,'L');	
		$this->SetFont('Arial','',7);
		$this->SetX(55); 			
		$this->Cell(60,3,"NPWP : ".$rNpwp['npwp'],0,1,'L');	
		$this->SetX(55); 			
		$this->Cell(60,3,$_SESSION['lang']['alamat']." NPWP : ".$rNpwp['alamatnpwp'],0,1,'L');	
	...
	/*	$pdf->MultiCell(126,50,$_SESSION['lang']['tgl_kirim'].": ".tanggalnormald($rlopoht->tanggalkirim).$pdf->Ln('4').
	   ...
	   $pdf->MultiCell(133,4,"Keterangan :"."\n".$rlopoht->uraian,'T',1,'J',0);
	   $pdf->SetY($akhirY);
...
//footer================================
   	  // $tmbhBrs3=$tmbhBrs2+45;
            $pdf->SetY($akhirY+$tmbhBrs3);
		
	//	if(($stat_release==0)&&($user_release==0000000000))
//		{
//			$pdf->SetY($akhirY+75);
//			$pdf->Cell(10,4,$_SESSION['lang']['purchaser'].": ".$nm_kary,0,0,'L',0);
//			$pdf->SetFont('Arial','U',8);
//			$pdf->Cell(175,4,'UNRELEASE PO, Please Contact Your Purchasing Manager',0,0,'R');
//			$pdf->Ln();
//		
...
//		{
			...
			//$pdf->Cell(185,4,$resv['namajabatan'],0,0,'R',0);
			//$pdf->Cell(185,4,'( .......................................... )',0,0,'R');
//			$pdf->Ln();
//			$pdf->Cell(150,4,'Jabatan :',0,0,'R');
	//	}
	$pdf->Output();
?>
