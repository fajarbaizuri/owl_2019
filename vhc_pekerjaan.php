...
while($rorg=mysql_fetch_assoc($qorg))
{
	...
	$soptOrg.="<option '".($rorg['kodeorganisasi']==$rorg['kodeorganisasi']?'selected=selected':'')."' value=".$rorg['kodeorganisasi']." >".$rorg['namaorganisasi']."</option>";
}
//----tab pertama...
...
$arrPremi=array("Non Premi","Premi");$optStatPremi='';
...
<input type=text class=myinputtextnumber id=jmlh_bbm name=jmlh_bbm maxlength=60 onkeypress=\"return angka_doang(event);\" style=width:150px; /> Liter</td></tr>
<tr><td colspan=3>
...
<fieldset style=\"float: left;\"><legend>".$_SESSION['lang']['find']." Data</legend><table cellspacing=\"1\" border=\"0\"><tr><td>".$_SESSION['lang']['notransaksi']."</td><td><input type=\"text\" id='txtCari' name='txtCari' style='width:150px' class=myinputtext />&nbsp;".$_SESSION['lang']['tanggal'].":<input type=text class=myinputtext id=tgl_cari onmousemove=setCalendar(this.id) onkeypress=return false;  size=10 maxlength=10 /><button class=mybutton id=cariTransaksi name=cariTransaksi onclick=cariDataTransaksi()  >".$_SESSION['lang']['find']."</button><button class=mybutton  onclick=load_data()  >".$_SESSION['lang']['cancel']."</button>
...
$frm[1].="<div id=formPekerjaan><fieldset><legend>".$_SESSION['lang']['vhc_detail_pekerjaan']."</legend>";
...
<select id=jns_kerja name=jns_kerja style=width:150px;><option value=></option>".$optJnsKerja."</select>
...
<tr><td>&nbsp;</td><td>&nbsp;</td><td>
<select id=blok name=blok  style=width:150px; ><option value=''>".$_SESSION['lang']['pilihdata']."</option></select> (* Jika pekerjaan dilakukan di Kebun
<input type=hidden name=old_blok id=old_blok />
</td></tr>
<tr><td>".$_SESSION['lang']['prestasi']."</td><td>:</td>
<td><input type=text class=myinputtextnumber id=brt_muatan name=brt_muatan maxlength=5 ".
" onkeypress=\"return angka_doang(event);\" style=width:150px; /> &nbsp;Unit/Mtr/Ha/Ton</td> </tr>
...
<input type=text class=myinputtextnumber id=kmhm_awal name=kmhm_awal maxlength=8".
" onkeypress=\"return angka_doang(event);\" style=width:150px; /></td></tr>
<tr><td>".$_SESSION['lang']['vhc_kmhm_akhir']."</td><td>:</td><td>
<input type=text class=myinputtextnumber id=kmhm_akhir name=kmhm_akhir maxlength=8".
"  onkeypress=\"return angka_doang(event);\" style=width:150px; /></td></tr>
...
//$skary="select a.karyawanid,a.nama from ".$dbname.".vhc_5operator a left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid where a.aktif='1' and b.lokasitugas='".$_SESSION['empl']['lokasitugas']."' ";//echo $skary;
...
//}
$arrPos=array("Sopir","Kondektur");$optPosition='';
...
<select id=posisi name=posisi style=width:150px; onchange=\"getPremi()\">".$optPosition."</select></select>
</td></tr>
<tr><td>".$_SESSION['lang']['upahkerja']."</td><td>:</td><td>
<input type=text id=uphOprt name=uphOprt class=myinputtextnumber style=width:150px; onkeypress='return angka_doang(event)' /> (* Harus di isi untuk karyawan internal</td></tr>
