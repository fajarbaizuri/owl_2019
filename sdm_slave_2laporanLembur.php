...
// ambil data lembur konversi ================================================================================
	...
	if(strlen($kdOrg)>4)
	{
		$sGetLembur="select jamaktual, jamlembur,tipelembur from ".$dbname.".sdm_5lembur where kodeorg = '".substr($kodeOrg,0,4)."'";
	}
	else
	{
...
// ambil data lembur ================================================================================
if($pilihan=='rupiah'){
     $sPeople="SELECT b.karyawanid as karyawanid, b.tanggal as tanggal, b.uangkelebihanjam as uangkelebihanjam, a.namakaryawan, a.bagian, a.kodejabatan
        ...
        $sPeople="SELECT b.karyawanid as karyawanid, b.tanggal as tanggal, b.jamaktual as uangkelebihanjam , b.tipelembur, a.namakaryawan, a.bagian, a.kodejabatan
			  FROM ".$dbname.".sdm_lemburdt b 
			  LEFT JOIN ".$dbname.".datakaryawan a on a.karyawanid = b.karyawanid
...
//		if($dzArr[$res['karyawanid']][nm]=='')$dzArr[$res['karyawanid']][nm]=$namakar[$res['karyawanid']]." *"; dikasih bintang bila karyawan tidak terdaftar di $namakar[]
//		if($dzArr[$res['karyawanid']][nm]=='')$dzArr[$res['karyawanid']][nm]=$res['karyawanid'].$namakar[$res['karyawanid']]."";
//		if($dzArr[$res['karyawanid']][jb]=='')$dzArr[$res['karyawanid']][jb]=$jab[$namaJabatan[$res['karyawanid']]];
...
//                    $dzArr[$res['karyawanid']]['tt']+=$res['uangkelebihanjam'];
//                    $tot[$res['tanggal']]+=$res['uangkelebihanjam'];
		}else{
                    $dzArr[$res['karyawanid']][$res['tanggal']]=$GetLembur[$res['uangkelebihanjam']][$res['tipelembur']];
//                    $dzArr[$res['karyawanid']]['tt']+=$GetLembur[$res['uangkelebihanjam']][$res['tipelembur']];
//                    $tot[$res['tanggal']]+=$GetLembur[$res['uangkelebihanjam']][$res['tipelembur']];
		} 
	}
...
class PDF extends FPDF
        {
            function Header() {
                ...
                $this->Line($this->lMargin,$this->tMargin+($height*4.3),
                $this->lMargin+$width,$this->tMargin+($height*4.3));
                $this->Ln();
...
*/
	...
	$stream.="<table border='0'><tr><td colspan='".$colatas."' align=center>".strtoupper("Rekapitulasi Lembur Karyawan")." : ".$nmOrg." (dalam ".$pilihan.") ".$pilihan2."</td></tr>
