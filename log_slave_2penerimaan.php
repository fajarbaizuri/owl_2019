...
//        param+='&kdGudang='+kdGudang+'&nmBrg='+nmBrg;
	...
	switch($method)
	{
	 ...
	 // stat_release='1'
		$str="SELECT distinct a.notransaksi,tanggal,nopo,kodegudang FROM ".$dbname.".log_transaksiht a left join ".$dbname.".log_transaksidt b on a.notransaksi=b.notransaksi
