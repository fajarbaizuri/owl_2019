...
<legend><b>04.5 HARI KERJA EFEKTIF KHT</b></legend>
...
<tr><td colspan=\"2\">
<button onclick=\"zPreview('lbm_slave_hari_kerja_efektif','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button>
<button onclick=\"zPdf('lbm_slave_hari_kerja_efektif','".$arr."','reportcontainer')\" class=\"mybutton\">PDF</button>    
<button onclick=\"zExcel(event,'lbm_slave_hari_kerja_efektif.php','".$arr."')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Excel</button></td></tr>
