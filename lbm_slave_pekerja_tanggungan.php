...
if($proses=='excel')
{
	...
	<tr>
        ...
        $tab.="<td ".$bgcoloraja." rowspan=2 colspan=3>Kantor Besar</td></tr>";
        $tab.="<tr>";
        foreach($dataAfd as $listAfd)
        {
	...
	<tbody>";
        //total pekerja
        $tab.="<tr class=rowcontent><td colspan=3><b>I. PEKERJA</b> </td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td>Panen</td><td>1. KHT </td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td>Perawatan</td><td>1. KHT </td>";
        ...
        $tab.="<tr class=rowcontent><td colspan=3><b>3. PEKERJA TIDAK LANGSUNG</b></td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td>1.Mandor</td><td>BULANAN </td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td>2.Krani</td><td>BULANAN </td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td>3.Lain-lain</td><td>BULANAN </td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td><b>Jumlah Pekerja</b></td><td>Bulanan</td>";
        ...
        $tab.="</tr>";
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td colspan=2><b>4. Pekerja Borongan</b> </td>";
        ...
        $tab.="<tr class=rowcontent><td colspan=3><b>II. TANGGUNGAN</b></td>";
        ...
        $tab.="<tr class=rowcontent><td>&nbsp;</td><td colspan=2><b>TOTAL PENDUDUK KEBUN</b></td>";
        ...
        case'pdf':
           ...
           class PDF extends FPDF {
            ...
            global $cols;
                ...
                $this->Cell(66,40,"Kantor Besar",1,1,'C',1);
                $tinggiAkr=$this->GetY();
                $ksamping=$this->GetX();
                $this->SetY($tinggiAkr-20);
            ...
            //total pekerja
            $pdf->Cell(180,$height,"I. PEKERJA",1,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            //2. PEKERJA LANGSUNG 
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(180,$height,"2. PEKERJA LANGSUNG ",1,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->Cell(100,$height,"1). Panen",TB,0,'L',0);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,$height," ",1,0,'L',1);
            $pdf->Cell(100,$height,"1). Perawatan",TB,0,'L',0);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(180,$height,"3. PEKERJA TIDAK LANGSUNG ",1,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,$height," ",1,0,'L',1);
            $pdf->Cell(100,$height,"1). Mandor",TB,0,'L',0);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,$height," ",1,0,'L',1);
            $pdf->Cell(100,$height,"2). Krani",TB,0,'L',0);
            $pdf->Cell(60,$height,": BULANAN",TB,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,$height," ",1,0,'L',1);
            $pdf->Cell(100,$height,"3). Lain-lain",TB,0,'L',0);
            $pdf->Cell(60,$height,": BULANAN",TB,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(20,$height," ",1,0,'L',1);
            $pdf->Cell(100,$height,"Jumlah Pekerja  ",TB,0,'L',0);
            $pdf->Cell(60,$height,": Bulanan",TB,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->Cell(22,$height,number_format($karyKhl2[$kdUnit],0),1,1,'R',1);
             ...
             //4. Borongan
            $pdf->SetFont('Arial','B',6);
            $pdf->Cell(180,$height,"4. Pekerja Borongan ",1,0,'L',1);
            $pdf->SetFont('Arial','',6);
            ...
            $pdf->Cell(22,$height,number_format(0,0),1,1,'R',1);
             ...
             //II. Tanggungan
            $pdf->Cell(180,$height,"II. TANGGUNGAN ",1,0,'L',1);
            $pdf->SetFont('Arial','',6);
