...
if($proses=='excel')
{
	...
	<tr>
        ...
        <td ".$bgcoloraja."  rowspan=2 colspan=4>KARYAWAN</td>
        <td ".$bgcoloraja." rowspan=3 colspan=2>".$_SESSION['lang']['total']."</td><tr>";
        $tab.="<tr><td  ".$bgcoloraja."  colspan=2>LAKI-LAKI</td><td  ".$bgcoloraja." colspan=2>PEREMPUAN</td></tr>";
        $tab.="<tr><td ".$bgcoloraja." >JUMLAH</td><td ".$bgcoloraja." >%</td><td ".$bgcoloraja." >JUMLAH</td><td ".$bgcoloraja." >%</td>
               <td ".$bgcoloraja." >JUMLAH</td><td ".$bgcoloraja." >%</td></tr>";
        $tab.="</thead>
	<tbody>";
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $afdId;
                ...
                $this->Cell(360,30,"KARYAWAN",1,0,'C',1);
                $this->Cell(180,60,$_SESSION['lang']['total'],1,0,'C',1);
                $tinggiAkr=$this->GetY();
                $ksamping=$this->GetX();
                $this->SetY($tinggiAkr+30);
                $this->SetX($ksamping-540);
                $this->Cell(180,30,"Laki-Laki",1,0,'C',1);
                $this->Cell(180,30,"Perempuan",1,0,'C',1);
                $tinggiAkr=$this->GetY();
                $ksamping=$this->GetX();
                $this->SetY($tinggiAkr+30);
                $this->SetX($ksamping-360);
                $this->Cell(90,20,"Jumlah",1,0,'C',1);
