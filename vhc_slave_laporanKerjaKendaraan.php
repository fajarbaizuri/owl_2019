...
$optBrg=makeOption($dbname, 'log_5masterbarang', 'kodebarang,namabarang',1,$where2);	
...
//                $sql="select * from ".$dbname.".vhc_rundt_vw where kodeorg='".substr($comId, 0,4)."' and 
//                    tanggal between  '".tanggalsystem($_POST['tglAwal'])."' and '".$tglAkhir."' ".$where."  order by tanggal,notransaksi asc";
		echo"
...
while($bar=mysql_fetch_object($res))
{
	$namapt=strtoupper($bar->namaorganisasi);
        ...
        /*        $sql="select a.*,b.*,c.idkaryawan,c.upah,c.premi from ".$dbname.".vhc_runht a 
                    left join ".$dbname.".vhc_rundt b on a.notransaksi=b.notransaksi 
                    left join ".$dbname.".vhc_runhk c on b.notransaksi=c.notransaksi where
                    a.kodeorg='".substr($comId, 0,4)."' and a.tanggal between  '".tanggalsystem($_GET['tglAwal'])."' and '".$tglAkhir."' ".$where." group by a.notransaksi order by a. tanggal asc";
         ...
         */
//                $sql="select * from ".$dbname.".vhc_rundt_vw where kodeorg='".substr($comId, 0,4)."' and 
//                    tanggal between  '".tanggalsystem($_GET['tglAwal'])."' and '".$tglAkhir."' ".$where." order by tanggal,notransaksi asc";
                    $sql="select distinct a.notransaksi,a.jenispekerjaan,a.alokasibiaya,a.jumlah,c.upah,c.premi,b.kodevhc,b.jenisvhc,
                      b.tanggal,a.jumlahrit,a.beratmuatan,a.biaya,a.keterangan,a.satuan,b.jenisbbm,b.jlhbbm
                      from ".$dbname.".vhc_rundt a left join ".$dbname.".vhc_runht b on a.notransaksi=b.notransaksi
                      left join ".$dbname.".vhc_runhk c on a.notransaksi=c.notransaksi where kodeorg='".substr($comId, 0,4)."' and 
                      b.tanggal between  '".tanggalsystem($tglAwal)."' and '".$tglAkhir."' ".$where." group by a.notransaksi,a.alokasibiaya,a.jenispekerjaan
                      order by b.tanggal,.a.notransaksi asc";
