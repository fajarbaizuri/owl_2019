...
<legend><b><?php echo $_SESSION['lang']['laporanPremi']?></b></legend>
...
<tr><td colspan="2">
	<button onclick="zPreview('sdm_slave_2laporanPremi','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	<button onclick="zPdf('sdm_slave_2laporanPremi','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button>
	<button onclick="zExcel(event,'sdm_slave_2laporanPremi.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview">Excel</button>
