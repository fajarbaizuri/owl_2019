...
<table>
    <tr><td><?echo $_SESSION['lang']['Type'];?></td><td><select id=tipe onchange="getCodeNumber(this.options[this.selectedIndex].value)"><option value=SUPPLIER>Supplier</option><option value=KONTRAKTOR>Kontraktor</option></select></td></tr>	
