...
//        $cols = "akt.tanggal,mat.notransaksi,mat.kodeorg,mat.kodebarang,mat.kwantitas,mat.kwantitasha,mat.hargasatuan";
        $cols = "mat.notransaksi,akt.tanggal,keg.namakegiatan,mat.kodeorg,mat.kodebarang,mat.kwantitas,mat.hargasatuan";
...
//            $_SESSION['lang']['kwantitasha'],
            $_SESSION['lang']['hargasatuan'],
        );
        $align = explode(",","L,L,L,L,L,R,R");
        break;
    default:
    break;
}
