...
while($rLuas=mysql_fetch_assoc($qLuas))
{
    ...
    {
        $dtLuasumur[$rLuas['tahuntanam']]+=$rLuas['luas'];
        @$xpertama2[$rLuas['tahuntanam']]=$dtLuasumur[$rLuas['tahuntanam']]/$dtLuas[$rLuas['tahuntanam']]*100;
    }
}
///mulai kedua
$sLuas="select tahuntanam,sum(luasareaproduktif) as luas from ".$dbname.".kebun_interval_panen1_vw 
...
while($rLuas=mysql_fetch_assoc($qLuas))
{
    ...
    {
        $dtLuasumur25[$rLuas['tahuntanam']]+=$rLuas['luas'];
        @$xkedua2[$rLuas['tahuntanam']]=$dtLuasumur25[$rLuas['tahuntanam']]/$dtLuas[$rLuas['tahuntanam']]*100;
    }
}
///mulai ketiga
$sLuas="select tahuntanam,sum(luasareaproduktif) as luas from ".$dbname.".kebun_interval_panen1_vw 
...
while($rLuas=mysql_fetch_assoc($qLuas))
{
    ...
    {
        $dtLuasumur30[$rLuas['tahuntanam']]+=$rLuas['luas'];
       @$xketiga2[$rLuas['tahuntanam']]=$dtLuasumur30[$rLuas['tahuntanam']]/$dtLuas[$rLuas['tahuntanam']]*100;
    }
}
...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=5 align=left><b>07. PUSINGAN POTONG BUAH</b></td><td colspan=7 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
	...
	<tr>
        <td ".$bgcoloraja." rowspan=3>".$_SESSION['lang']['tahuntanam']."</td>
        <td ".$bgcoloraja." rowspan=3>LUAS PANEN (HA)</td><td ".$bgcoloraja." colspan=8>LUAS PANEN (HA)</td</tr>";
        $tab.="<tr><td ".$bgcoloraja." colspan=2>< 9 Hari</td><td ".$bgcoloraja." colspan=2>10-15 Hari</td>";
        $tab.="<td ".$bgcoloraja." colspan=2>16-20 Hari</td>";
        $tab.=" <td ".$bgcoloraja." colspan=2> >20 Hari</td></tr>";
        $tab.="<tr><td>B.I</td><td>B.L</td><td>B.I</td><td>B.L</td><td>B.I</td><td>B.L</td><td>B.I</td><td>B.L</td>";
        $tab.="</thead>
	<tbody>";
        ...
        @$bi1=$totBi1/$totLuas*100;
        @$bl1=$totBl1/$totLuas*100;
        @$bi2=$totBi2/$totLuas*100;
        @$bl2=$totBl2/$totLuas*100;
        @$bi3=$totBi3/$totLuas*100;
        @$bl3=$totBl3/$totLuas*100;
        @$bi4=$totBi4/$totLuas*100;
        @$bl4=$totBl4/$totLuas*100;
        $tab.="<tr class=rowcontent>";
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $afdId;
                ...
                $this->Cell($width,$height,strtoupper("07. PUSINGAN POTONG BUAH"),0,1,'L');
                ...
                $this->SetY($tinggiAkr+20);
                $this->SetX($ksamping);
                $this->Cell(60,$height,"TAHUN",TLR,0,'C',1);
                $this->Cell(60,$height,"LUAS",TLR,0,'C',1);
                $this->Cell(400,$height,"INTERVAL PANEN (%)",TLR,1,'C',1);
                
                $this->Cell(60,$height,"TANAM",LR,0,'C',1);
                $this->Cell(60,$height,"PANEN",LR,0,'C',1);
                $this->Cell(100,$height,"< 9 Hari",TLR,0,'C',1);
                $this->Cell(100,$height,"10-15 Hari",TLR,0,'C',1);
                $this->Cell(100,$height,"16-20 Hari",TLR,0,'C',1);
                $this->Cell(100,$height,">20 Hari",TLR,1,'C',1);
                
                $this->Cell(60,$height," ",BLR,0,'C',1);
                $this->Cell(60,$height,"(HA)",BLR,0,'C',1);
                $this->Cell(50,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.L",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.L",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.L",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(50,$height,"B.L",TBLR,1,'C',1);
          }
              function Footer()
            {
                $this->SetY(-15);
