...
//ambil query untuk data karyawan
	...
	/*$wh="select * from ".$dbname.".datakaryawan a join ".$dbname.".kebun_5nourutmandor b where a.karyawanid=b.karyawanid and b.nikmandor='".$mandor."' "; 
	$whh=mysql_query($wh);
	$whhh=mysql_fetch_assoc($whh);
		$xxx=$whhh['nikmandor'];
...
$data=mysql_fetch_assoc($qry);
	...
	$stream.="<tr><td colspan='".$colatas."'>&nbsp;</td></tr>";
...
*/
	...
	$sGetKary="select d.*,a.karyawanid,b.namajabatan,a.namakaryawan,c.nama from ".$dbname.".datakaryawan a 
           left join ".$dbname.".sdm_5jabatan b on a.kodejabatan=b.kodejabatan 
