...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=8 align=left><b>06. OUTPUT POTONG BUAH</b></td><td colspan=8 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
    ...
    $tab.="<tr><td colspan=8 align=left>&nbsp;</td></tr>
       ...
       $tab.="<td colspan=6 ".$bgcoloraja.">JUMLAH HK</td>";
       $tab.="<td colspan=6 ".$bgcoloraja.">JUMLAH  (KG)</td>";
       $tab.="<td colspan=2 rowspan=2 ".$bgcoloraja.">Janjang Dikirim</td>";
       $tab.="<td colspan=2 rowspan=2 ".$bgcoloraja.">Total  Produksi</td>";
       $tab.="<td colspan=2 rowspan=2 ".$bgcoloraja.">TBS  Dikirim</td>";
       $tab.="<td colspan=2 rowspan=2 ".$bgcoloraja.">Var. Prod.</td>";
       $tab.="<td colspan=3 ".$bgcoloraja.">B J R</td>";
       ...
       $tab.="<td colspan=2 ".$bgcoloraja.">Target Basis</td><td colspan=2 ".$bgcoloraja.">Lebih Borong</td><td colspan=2 ".$bgcoloraja.">Realisasi</td>";
       $tab.="<td colspan=2 ".$bgcoloraja.">Aktual</td><td rowspan=2 ".$bgcoloraja.">Sensus SM-I/II</td>";
       $tab.="<td colspan=2 ".$bgcoloraja.">Target Basis</td><td colspan=2 ".$bgcoloraja.">Lebih Borong</td><td colspan=2 ".$bgcoloraja.">Realisasi</td></tr>";
       $tab.="<tr><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">%</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">%</td>";
       $tab.="<td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td>";
       $tab.="<td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td>B.I</td><td>s/d  B.I</td>";
       $tab.="<td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td>";
       $tab.="<td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td><td ".$bgcoloraja.">B.I</td><td ".$bgcoloraja.">s/d  B.I</td></tr>";
       $tab.="</thead><tbody>";
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $afdId;
                ...
                $this->Cell($width,$height,strtoupper("06. OUTPUT POTONG BUAH"),0,1,'L');
                ...
                $this->Cell(25,$height,"TAHUN ",TLR,0,'C',1);
                $this->Cell(120,$height,"JUMLAH HK",TBLR,0,'C',1);
                $this->Cell(180,$height,"JUMLAH  (KG)",TBLR,0,'C',1);
                $this->Cell(50,$height,"Janjang Dikirim",TLR,0,'C',1);
                $this->Cell(60,$height,"Total  Produksi",TLR,0,'C',1);
                $this->Cell(60,$height,"TBS  Dikirim",TLR,0,'C',1);
                $this->Cell(60,$height,"Var. Prod.",TBLR,0,'C',1);
                $this->Cell(70,$height,"B J R",TBLR,0,'C',1);
                ...
                $this->Cell(60,$height,"Realisasi",TBLR,0,'C',1);
                $this->Cell(50,$height,"ke Pabrik",BLR,0,'C',1);
                $this->Cell(60,$height,"Kebun  ( Kg )",BLR,0,'C',1);
                $this->Cell(60,$height,"ke Pabrik ( Kg )",BLR,0,'C',1);
                $this->Cell(60,$height,"KBN-PKS(%)",BLR,0,'C',1);
                $this->Cell(40,$height,"Aktual",TBLR,0,'C',1);
                $this->Cell(30,$height,"Sensus",TLR,0,'C',1);
                $this->Cell(60,$height,"Target Basis",TBLR,0,'C',1);
                $this->Cell(60,$height,"Lebih Borong",TBLR,0,'C',1);
                $this->Cell(60,$height,"Realisasi",TBLR,1,'C',1);
                
                $this->Cell(25,$height," ",BLR,0,'C',1);
                $this->Cell(20,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(20,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(20,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(20,$height,"%",TBLR,0,'C',1);
                $this->Cell(20,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(20,$height,"%",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(25,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(25,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                ...
                $this->Cell(30,$height,"s/d  B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"B.I",TBLR,0,'C',1);
                $this->Cell(30,$height,"s/d  B.I",TBLR,1,'C',1);
