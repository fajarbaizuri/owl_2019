...
case'pdf':
		...
		if($thnBudget=='')
		{
			echo "warning : Tahun Budget Tidak Boleh Kosong";
			exit();	
		}
		else if($kodeOrg=='')
		{
			echo "warning : Kode Traksi Tidak Boleh Kosong";
			exit();	
		}
            ...
            function Header() 
			{
				...
				global $namakar;
						...
						$this->Cell(13/100*$width,$height,$_SESSION['lang']['kodeorg'],1,0,'C',1);
 						$this->Cell(13/100*$width,$height,$_SESSION['lang']['kodeanggaran'],1,0,'C',1);
