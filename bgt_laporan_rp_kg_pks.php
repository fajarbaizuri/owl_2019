...
OPEN_BOX('',$_SESSION['lang']['budget']."  ".$_SESSION['lang']['pabrik']);
#ambil tahun budget
...
echo"<fieldset style='width:500px;'><table>
     ...
     <option value='LANGSUNG DAN UMUM'>HPP</option>
     <option value='PENJUALAN'>Biaya Penjualan</option>
     </select></td></tr>
     </table>
	 <input type=hidden id=method value='insert'>
	 <button class=mybutton onclick=tampilkanRPKGPks()>".$_SESSION['lang']['save']."</button>
	 </fieldset>";
