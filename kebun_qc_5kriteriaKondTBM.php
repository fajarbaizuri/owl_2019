...
<script type="text/javascript" src="js/kebun_qc_5kriteriaKondTBM.js"></script>
<script>
dataKdvhc="<?php echo $_SESSION['lang']['pilihdata']?>";
</script>
<?php
$optKode.="<option value=''>".$_SESSION['lang']['pilihdata']."</option>";
$sField="select * from ".$dbname.".kebun_qc_kondisitbmdt";
...
OPEN_BOX('',"<b>Kriteria Kondisi Lapangan TBM</b>");
$frm[0].="<fieldset><legend>Kriteria Kondisi Lapangan TBM</legend>";
...
$frm[1].="<table cellspacing=1 border=0>
    ...
    <tr>
        <td>".$_SESSION['lang']['kelastanah']."</td><td>:</td>
...
//========================
$hfrm[0]="Kriteria Kondisi Lapangan TBM";
$hfrm[1]="Bobot Nilai";
