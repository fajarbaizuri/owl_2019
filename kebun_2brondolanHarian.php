...
<legend><b>LAPORAN BRONDOLAN HARIAN</b></legend>
...
<tr><td colspan="2"><button onclick="zPreview('kebun_slave_2brondolan','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['preview']?></button>



<button onclick="zExcel(event,'kebun_slave_2brondolan.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['excel']?></button>
