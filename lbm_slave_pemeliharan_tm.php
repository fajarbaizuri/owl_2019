...
// cari kegiatan
$kegiatan="SELECT kodekegiatan, namakegiatan, satuan FROM ".$dbname.".setup_kegiatan WHERE `kelompok` = 'TM' order by kodekegiatan";
...
$tab.="<table border=0>
     <tr>
        <td colspan=15 align=left><font size=3>10. PEMELIHARAAN TM (HA-HK)</font></td>
...
switch($proses)
{
    ...
    function Header() {
        ...
        $this->Cell($width/2,$height,'10. PEMELIHARAAN TM (HA-HK) ',NULL,0,'L',1);
