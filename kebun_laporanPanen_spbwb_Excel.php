<?php
    ...
    {
        $str="select a.blok,a.tanggal,a.nospb,a.notiket,a.nokendaraan,a.jjg,a.kgwb,a.bjr from ".$dbname.".kebun_spb_vw a
        left join ".$dbname.".organisasi c
        on substr(a.kodeorg,1,4)=c.kodeorganisasi
        where c.induk = '".$pt."'  and a.tanggal between ".tanggalsystem($tgl1)." and ".tanggalsystem($tgl2)." order by a.blok, a.tanggal";
    }
    else
    {
        $str="select a.blok,a.tanggal,a.nospb,a.notiket,a.nokendaraan,a.jjg,a.kgwb,a.bjr from ".$dbname.".kebun_spb_vw a
        where blok like '".$unit."%'  and a.tanggal between ".tanggalsystem($tgl1)." and ".tanggalsystem($tgl2)." order by a.blok, a.tanggal";
    }	
    ...
    $stream.="<thead>
            ...
            <td align=center>".$_SESSION['lang']['bjr']." Budget</td>
        </tr>
        </thead>
	<tbody>";
    ...
    if(mysql_num_rows($res)<1){
        ...
        $stream.="<tr class='rowcontent'>
            ...
            $kgwb=$bar->kgwb;
            if($kgwb!=0)
            $stream.="<td align=right>".number_format($kgwb,2)."</td>";else{
            ...
            <td align=right>".number_format($bar->bjr,2)."</td></tr>";
        }
    } 
    $stream.="</tbody>
        <tfoot>
