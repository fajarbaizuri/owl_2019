...
//			}
		//echo $strx; exit();
				...
				// kesalahan wibi
				//$strx="SELECT * FROM ".$dbname.".log_poht where lokalpusat='0'  ".$where." order by tanggal desc limit ".$offset.",".$limit."";
				//$sql2="SELECT count(*) as jmlhrow FROM ".$dbname.".log_poht where lokalpusat='0' ".$where." order by tanggal desc ";	 
				$strx="SELECT * FROM ".$dbname.".log_poht where   ".$where." order by tanggal desc limit ".$offset.",".$limit."";
				$sql2="SELECT count(*) as jmlhrow FROM ".$dbname.".log_poht where  ".$where." order by tanggal desc ";	 
...
//						  {
	 ...
	 // stat_release='1'
		$str="SELECT * FROM ".$dbname.".log_poht where lokalpusat='0'  ORDER BY tanggal DESC limit ".$offset.",".$limit."";
			//echo $str;
