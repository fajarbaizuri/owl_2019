		 ...
		 $res1=mysql_query($str1);	
					 ...
					 $res2=mysql_query($str2);	
								 ...
								 $res3=mysql_query($str3);	
											 ...
											 $res4=mysql_query($str4);	
														 ...
														 $res5=mysql_query($str5);	
															...
															//=========================================================
																	 ...
																	 $res6=mysql_query($str6);	
																		 ...
																		 <li><div id=inputmenu".$bar5->id." class=menuinput  style='display:none;'>
																		  ...
																		  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar5->id."','newCaption".$bar5->id."','newAction".$bar5->id."','link".$bar5->id."','inputmenu".$bar5->id."','type".$bar5->id."','newFile".$bar5->id."');>
															...
															//========================================================																			
															 ...
															 echo"</div>
															  ...
															  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar4->id."','newCaption".$bar4->id."','newAction".$bar4->id."','link".$bar4->id."','inputmenu".$bar4->id."','type".$bar4->id."','newFile".$bar4->id."');>
												...
												//========================================================																
												 ...
												 echo"</div>
												  ...
												  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar3->id."','newCaption".$bar3->id."','newAction".$bar3->id."','link".$bar3->id."','inputmenu".$bar3->id."','type".$bar3->id."','newFile".$bar3->id."');>
									...
									//========================================================												
									 ...
									 echo"</div>
									  ...
									  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar2->id."','newCaption".$bar2->id."','newAction".$bar2->id."','link".$bar2->id."','inputmenu".$bar2->id."','type".$bar2->id."','newFile".$bar2->id."');>
						...
						//========================================================
						 ...
						 echo"</div>
							  ...
							  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar1->id."','newCaption".$bar1->id."','newAction".$bar1->id."','link".$bar1->id."','inputmenu".$bar1->id."','type".$bar1->id."','newFile".$bar1->id."');>
			...
			//========================================================
			 ...
			 echo"</div>			 
				  ...
				  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu".$bar->id."','newCaption".$bar->id."','newAction".$bar->id."','link".$bar->id."','inputmenu".$bar->id."','type".$bar->id."','newFile".$bar->id."');>
...
echo "</div>
	  ...
	  <input type=button class=mybutton value=".$_SESSION['lang']['save']." onclick=saveMenu('master_menu0','newCaption0','newAction0','link0','inputmenu0','type0','newFile0');>
