...
$sTipe="select id,tipe from ".$dbname.".sdm_5tipekaryawan where id NOT IN ('2','5') order by tipe asc";
//echo $sTipe;
...
<?php if($_SESSION['empl']['tipelokasitugas']=='HOLDING'){?><tr><td><label><?php echo $_SESSION['lang']['unit']?></label></td><td><?php echo $optOrg?></td></tr><?php } ?>
