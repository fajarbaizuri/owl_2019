...
$str="select a.karyawanid,a.tanggal,sum(a.upahpremi-a.rupiahpenalty) as upahpremi,b.kodejabatan,c.namajabatan from ".$dbname.".kebun_prestasi a 
...
/*
$sql="select a.karyawanid,a.tanggal,sum(a.insentif) as upahpremi,b.kodejabatan,c.namajabatan from ".$dbname.".kebun_kehadiran_vw a 
     left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid
     left join ".$dbname.".sdm_5jabatan c on b.kodejabatan=c.kodejabatan
     where substr(a.tanggal,1,7)='".$periode."' and insentif!=0 and b.lokasitugas='".substr($kdOrg,0,4)."' and (b.tanggalkeluar>'".$tanggalSampai."' or b.tanggalkeluar='0000-00-00')
     group by a.karyawanid,tanggal 
     order by a. karyawanid";
	*/
$sql="select a.karyawanid,a.tanggal,sum(a.insentif) as upahpremi,b.kodejabatan,c.namajabatan from ".$dbname.".kebun_kehadiran_new_vw a 
     left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid
     left join ".$dbname.".sdm_5jabatan c on b.kodejabatan=c.kodejabatan
     where substr(a.tanggal,1,7)='".$periode."' and insentif!=0 and b.lokasitugas='".substr($kdOrg,0,4)."' and (b.tanggalkeluar>'".$tanggalSampai."' or b.tanggalkeluar='0000-00-00')
     group by a.karyawanid,tanggal 
...
//ambil data traksi
//premi traksi
$sql3="select a.idkaryawan as karyawanid,a.tanggal,sum(a.premi-a.penalty) as upahpremi, b.kodejabatan,c.namajabatan from ".$dbname.".vhc_runhk a 
...
$str="select a.karyawanid,a.tanggal,sum(a.upahpremi-a.rupiahpenalty) as upahpremi,b.kodejabatan,c.namajabatan from ".$dbname.".kebun_prestasi_vw a 
     left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid
     left join ".$dbname.".sdm_5jabatan c on b.kodejabatan=c.kodejabatan
...
$sql="select a.karyawanid,a.tanggal,sum(a.insentif) as upahpremi,b.kodejabatan,c.namajabatan from ".$dbname.".kebun_kehadiran_vw a 
     left join ".$dbname.".datakaryawan b on a.karyawanid=b.karyawanid
     left join ".$dbname.".sdm_5jabatan c on b.kodejabatan=c.kodejabatan
     where substr(a.tanggal,1,7)='".$periode."' and insentif!=0  ".$whr." and (b.tanggalkeluar>'".$tanggalSampai."' or b.tanggalkeluar='0000-00-00')
