...
<script language=javascript1.2 src='js/bgt_labarugi_budgetpks.js'></script>
<?
include('master_mainMenu.php');
OPEN_BOX('','LABA RUGI PKS MENURUT BUDGET');
#ambil tahun budget
...
echo"<fieldset style='width:500px;'><table>
	 ...
	 <button class=mybutton onclick=tampilkanLRPks()>".$_SESSION['lang']['save']."</button>
	 </fieldset>";
