...
switch($proses) {
    case 'all':
		...
		## Get Data
		$q = selectQuery($dbname,'pabrik_ops_gensetht','*',"tanggal between '".
    ...
    case 'detail':
		...
		$q = selectQuery($dbname,'pabrik_ops_gensetdt',$cols,"notransaksi='".
			$param['notransaksi']."'");
		$data = fetchData($q);
