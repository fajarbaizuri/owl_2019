...
//kamus kodeakun    
    ...
    $str="select * from ".$dbname.".bgt_budget
        where kodebudget in ('UMUM','PENJUALAN') and tipebudget = '".$tipebudget."' and kodeorg = '".$kodeorg."' and tahunbudget like '%".$pilihtahun0."%'
...
//        where kodeorg = '".$mesin."' and kodeorg like '".substr($_SESSION['empl']['lokasitugas'],0,4)."%'";
    $str="select a.*, b.tutup from ".$dbname.".bgt_budget_detail a
        ...
        where a.kodebudget in ('UMUM','PENJUALAN') and a.tipebudget = '".$tipebudget."' and a.kodeorg = '".$kodeorg."' and a.tahunbudget like '%".$pilihtahun1."%'
            order by a.tahunbudget desc, a.noakun";

//    $str="select * from ".$dbname.".bgt_budget_detail
//        where kodebudget like 'UMUM%' and tipebudget = '".$tipebudget."' and kodeorg = '".$kodeorg."' and tahunbudget like '%".$pilihtahun1."%'
//            order by tahunbudget desc,noakun";
    $res=mysql_query($str);
    $no=1;
    while($bar= mysql_fetch_object($res))
...
//        where kodeorg = '".$mesin."' and kodeorg like '".substr($_SESSION['empl']['lokasitugas'],0,4)."%'";
    $str="select * from ".$dbname.".bgt_budget
        where tutup=0 and kodebudget in ('UMUM','PENJUALAN') and tipebudget = '".$tipebudget."' and kodeorg = '".$kodeorg."' and tahunbudget like '%".$pilihtahun2."%'
            order by tahunbudget desc,noakun";
    $res=mysql_query($str);
    $no=1;
    while($bar= mysql_fetch_object($res))
...
if($cekapa=='insertDistribusi')
{
    for($a=1;$a<=12;$a++)
        ...
        {
            exit("Error : Total Berat Perbulan (".$totalSum.") Lebih Besar Dari Total Setahun (".$_POST['totalSetahn'].") ");    
        }
