...
{
			echo"<tr class=rowcontent style='cursor:pointer;' title='Click untuk melihat detail' onclick=\"lihatDetailArus(-1,'".$barE->noarus."','".$pt."','".$gudang."','".$periode."','".$noakun."',event);\">
               <td>".$barE->noarus."</td>
               <td>".$barE->uraian."</td>
...
{
			echo"<tr class=rowcontent style='cursor:pointer;' title='Click untuk melihat detail' onclick=\"lihatDetailArus(1,'".$barE1->noarus."','".$pt."','".$gudang."','".$periode."','".$noakun."',event);\">
               <td>".$barE1->noarus."</td>
               <td>".$barE1->uraian."</td>
...
echo"<tr class=rowcontent>
	 ...
	 if ($TOTOKMR < 0){
			echo"<td align=right><b>(".number_format($TOTOKMR * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($TOTOKMR)."</b></td>";
	 }
	 
	 if ($TOTOINI < 0){
			echo"<td align=right><b>(".number_format($TOTOINI * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($TOTOINI)."</b></td>";
	 }
...
echo"<tr class=rowcontent><td colspan=4 align=left></td></tr>
<tr class=rowcontent>
...
{
			echo"<tr class=rowcontent style='cursor:pointer;' title='Click untuk melihat detail' onclick=\"lihatDetailArus(-1,'".$barE2->noarus."','".$pt."','".$gudang."','".$periode."','".$noakun."',event);\">
               <td>".$barE2->noarus."</td>
               <td>".$barE2->uraian."</td>
...
{
			echo"<tr class=rowcontent style='cursor:pointer;' title='Click untuk melihat detail' onclick=\"lihatDetailArus(1,'".$barE3->noarus."','".$pt."','".$gudang."','".$periode."','".$noakun."',event);\">
               <td>".$barE3->noarus."</td>
               <td>".$barE3->uraian."</td>
...
echo"<tr class=rowcontent>
	 ...
	 ";
	 if ($TOTIKMR < 0){
			echo"<td align=right><b>(".number_format($TOTIKMR * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($TOTIKMR)."</b></td>";
	 }
	 
	 if ($TOTIINI < 0){
			echo"<td align=right><b>(".number_format($TOTIINI * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($TOTIINI)."</b></td>";
	 }
...
{
			echo"<tr class=rowcontent style='cursor:pointer;' title='Click untuk melihat detail' onclick=\"lihatDetailArus(1,'".$barE5->noarus."','".$pt."','".$gudang."','".$periode."','".$noakun."',event);\">
               <td>".$barE5->noarus."</td>
               <td>".$barE5->uraian."</td>
...
echo"<tr class=rowcontent>
	 ...
	 <td colspan=2 align=right><b>ARUS KAS BERSIH AKTIVITAS PENDANAAN</b></td>
	  ";
	 if ($TOTPKMR < 0){
			echo"<td align=right><b>(".number_format($TOTPKMR * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($TOTPKMR)."</b></td>";
	 }
	 
	 if ($TOTPINI < 0){
			echo"<td align=right><b>(".number_format($TOTPINI * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($TOTPINI)."</b></td>";
	 }
...
echo"<tr class=rowcontent>
           <td colspan=2 align=right><b>KENAIKAN (PENURUNAN) KAS</b></td>
		    ";
	 if ($TOTKMRALL < 0){
			echo"<td align=right><b>(".number_format($TOTKMRALL * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($TOTKMRALL)."</b></td>";
	 }
	 
	 if ($TOTINIALL < 0){
			echo"<td align=right><b>(".number_format($TOTINIALL * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($TOTINIALL)."</b></td>";
	 }
	 ...
	 if ($ArrSaldoAwal['KMR'] < 0){
			echo"<td align=right><b>(".number_format($ArrSaldoAwal['KMR'] * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($ArrSaldoAwal['KMR'])."</b></td>";
	 }
	 
	 if ($ArrSaldoAwal['INI'] < 0){
			echo"<td align=right><b>(".number_format($ArrSaldoAwal['INI'] * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($ArrSaldoAwal['INI'])."</b></td>";
	 }
	 ...
	 if ($ArrSaldoAkhir['KMR'] < 0){
			echo"<td align=right><b>(".number_format($ArrSaldoAkhir['KMR'] * -1 ).")</b></td>";
	 }else{
		   echo"<td align=right><b>".number_format($ArrSaldoAkhir['KMR'])."</b></td>";
	 }
	 
	 if ($ArrSaldoAkhir['INI'] < 0){
			echo"<td align=right><b>(".number_format($ArrSaldoAkhir['INI'] * -1 ).")</b></td>";
	 }else{
			echo"<td align=right><b>".number_format($ArrSaldoAkhir['INI'])."</b></td>";
	 }
