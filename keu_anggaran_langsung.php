...
#echo "</pre>";
?>
<script language=javascript src=js/keu_anggaran_langsung.js></script>
...
# Prepare Options
$holding = getHolding($dbname,$_SESSION['empl']['kodeorganisasi']);
if($holding!=false) {
    $kelompok = array(''=>'');
...
$els2 = array();
$els2[] = array(
    makeElement('prosesKelompok','label',$_SESSION['lang']['kelompok']),
    makeElement('prosesKelompok','select','',array('style'=>'width:150px'
        ,'onchange'=>"getKegiatan(this,'prosesKodekegiatan')",'disabled'=>'disabled'),$kelompok)
);
$els2[] = array(
    makeElement('prosesKodekegiatan','label',$_SESSION['lang']['kodekegiatan']),
    makeElement('prosesKodekegiatan','select','',array('style'=>'width:150px'
...
$container = "<fieldset style='float:left;clear:left;height:200px'>".
  "<legend><b>Header</b></legend><div id='headContainer'>";
$container .= genElement($els);
$container .= "</div></fieldset>";

$container .= "<fieldset style='float:left;clear:right;height:200px'>".
  "<legend><b>Proses</b></legend><div id='processContainer'>";
$container .= genElement($els2);
$container .= makeElement('autoFillBtn','btn','Proses',
    array('onclick'=>'autoFill()','disabled'=>'disabled'));
$container .= "</div></fieldset>";
