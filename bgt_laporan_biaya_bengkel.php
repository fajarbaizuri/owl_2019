...
<legend><b><?php echo $_SESSION['lang']['biaya'].$_SESSION['lang']['workshop']?></b></legend>
...
<tr><td><label><?php echo $_SESSION['lang']['workshop']?></label></td><td><select id='kdWS'  style="width:150px;"><?php echo $optOrg?></select></td></tr>
<tr height="20"><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2"><button onclick="zPreview('bgt_slave_laporan_biaya_bengkel','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['preview']?></button>
