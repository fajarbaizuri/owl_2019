...
//$sOrg="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where CHAR_LENGTH(kodeorganisasi)='4' 
  //  and (tipe = 'kebun' or tipe = 'pabrik') order by namaorganisasi asc";
$sOrg="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where CHAR_LENGTH(kodeorganisasi)='4' and tipe = 'kebun' and right(kodeorganisasi,1)='E' order by namaorganisasi asc";  
...
<table cellspacing=\"1\" border=\"0\" >
   ...
   <tr><td><label>".$_SESSION['lang']['periode']."</label></td><td><select id='periode' style=\"width:200px;\">".$optperiode."</select></td></tr>
    ...
    <tr><td colspan=\"2\"> 
    <button onclick=\"zPreview('lmk_slave_biaya_produksi_kebun','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">".$_SESSION['lang']['preview']."</button>
    <button onclick=\"zExcel(event,'lmk_slave_biaya_produksi_kebun.php','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"excel\" id=\"excel\">".$_SESSION['lang']['excel']."</button>    
    <button onclick=\"zPdf('lmk_slave_biaya_produksi_kebun','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"pdf\" id=\"pdf\">". $_SESSION['lang']['pdf']."</button>
