...
$detailContent[1].="<td></td></tr>
    ...
    <td><img src=images/clear.png onclick=bersihkanAja('s2s') style='height:30px;cursor:pointer' title='bersihkan'></td>
    </tr>
    </table>  ";
...
$resSebaran = fetchData($sLoad);*/
		...
		//$ql2="select count(*) as jmlhrow from ".$dbname.".qc_panen  ";// echo $ql2;notran
		
		$ql2="select count(*) as jmlhrow from ".$dbname.".bgt_budget_detail a left join ".$dbname.".setup_kegiatan b ".
    "on a.kegiatan=b.kodekegiatan where b.kelompok in ('TB','LC','PNN','TBM','TM') and a.kodeorg like '".
        $_SESSION['empl']['lokasitugas']."%' and not kodebudget in ('UMUM','OTHER') and tipebudget='ESTATE' and tutup=0 and tahunbudget=".date('Y');
...
$sLoad="select a.tahunbudget,a.kodeorg,a.kodebudget,a.kegiatan,a.rupiah,a.kodevhc,a.kodebarang,a.kunci,a.jumlah,a.rp01
,a.rp02,a.rp03,a.rp04,a.rp05,a.rp06,a.rp07,a.rp08,a.rp09,a.rp10,a.rp11,a.rp12 from ".$dbname.".bgt_budget_detail a left join ".$dbname.".setup_kegiatan b ".
    "on a.kegiatan=b.kodekegiatan where b.kelompok in ('TB','LC','PNN','TBM','TM') and a.kodeorg like '".
        $_SESSION['empl']['lokasitugas']."%' and not kodebudget in ('UMUM','OTHER') and tipebudget='ESTATE' and tutup=0 and tahunbudget=".date('Y')." limit ".$offset.",".$limit." ";
...
foreach($resSebaran as $key=>$row) {
        ...
        $dtClik="onclick=\"getForm('Sebaran','<fieldset style=\'width:520px;height:400px;\'>".
                ...
                "width:480px\'></div><input type=hidden id=keyId2s value=\'".$row['kunci']."\'></fieldset>',".
...
$detailContent[1].="
		...
		".($offset+1)." to ".($offset+$limit)." Of ".  $jlhbrs."<br />";
		if(isset($page))
		{
			$totalPages = ceil($jlhbrs / $limit);
			if($page <=1 )
			{
				$detailContent[1].="<button class=mybutton>".$_SESSION['lang']['pref']."</button>";
			}else{
				$j = $page - 1;
				$detailContent[1].="<button class=mybutton onclick=cariBastSebarRawat(".($j).");>".$_SESSION['lang']['pref']."</button>";
			}
			$detailContent[1].="<select name=select1 onchange=choosePage(this);>";
			for($i=1; $i <= $totalPages; $i++)
			{
				if($i<>$page)
				{
					$detailContent[1].="<option value=$i >$i</option>";
					//echo "<span><a href='index.php?page=$i' id='page_a_link'>$i</a></span>";
				}else{
					$detailContent[1].="<option value=$i selected>$i</option>";
					//echo "<span id='page_links' style='font-weight:bold;'>$i</span>";
				}
			}
			$detailContent[1].="</select>";
			if($page == $totalPages )
			{
				
				$res.="<button class=mybutton >".$_SESSION['lang']['lanjut']."</button>";
			}
			else
			{
			$j = $page + 1;
			$detailContent[1].="<button class=mybutton onclick=cariBastSebarRawat(".($j).");>".$_SESSION['lang']['lanjut']."</button>";
			}
...
$contentFrame[3] = OPEN_BOX2();
$contentFrame[3] .= "<fieldset style='float:left;clear:right'><legend>".$_SESSION['lang']['entryForm']."</legend> <table border=0 cellpadding=1 cellspacing=1>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['budgetyear']."</td><td><input type='text' class='myinputtextnumber' id='thnBudget4' style='width:150px;' maxlength='4' onkeypress='return angka_doang(event)' /></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['tipe']."</td><td><input type='text' class='myinputtext' disabled value='ESTATE' id='tipeBudget4' style=width:150px; /></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['afdeling']."</td><td>".makeElement('afd4','select','',array('style'=>'width:150px;'),$optAfd)."</td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['tahuntanam']."</td><td>".makeElement('tahuntanam4','textnum','',array('style'=>'width:150px;','maxlength'=>4))."</td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['kegiatan']."</td><td><select style='width:150px;' id='kegId4' onchange='getSatuan(\"lain\")'>".$optKeg1."</select></td></tr>"; 
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['noakun']."</td><td><input type='text' class='myinputtextnumber' id='noAkun4' disabled style='width:150px;' onkeypress='return angka_doang(event)' /></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['rotasi']."/".$_SESSION['lang']['tahun']."</td><td><input type='text' class='myinputtextnumber' id='rotThn4' style='width:150px;' onkeypress='return tanpa_kutip(event)' value='1' onchange='getTotalLain()'/></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['volume']."</td><td><input type='text' class='myinputtextnumber' id='volKeg4'  style='width:150px;' onkeypress='return angka_doang(event)' onchange='getTotalLain()'/></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['satuan']."</td><td><input type='text' class='myinputtext' id='satKeg4' style='width:150px;' onkeypress='return tanpa_kutip(event)' /></td></tr>";
$contentFrame[3] .= "<tr><td>".$_SESSION['lang']['persen']."</td><td><input type='text' maxlength='3' class='myinputtextnumber' id='persen4' style='width:135px;' onkeypress='return angka_doang(event)' onblue=ubahvolume(this.value) value=100 onchange='getTotalLain()' />&nbsp;%</td></tr>";
$contentFrame[3] .= "<tr><td>Harga Satuan</td><td><input type='text' class='myinputtextnumber' id='HSatuan4'  style='width:150px;' onkeypress='return angka_doang(event)' onchange='getTotalLain()'/></td></tr>";
$contentFrame[3] .= "<tr><td>Total</td><td><input type='text' class='myinputtextnumber' id='Total4'  style='width:150px;' onkeypress='return angka_doang(event)' disabled/></td></tr>";

$contentFrame[3] .= "<tr><td colspan='2'><button class=\"mybutton\"  id=\"saveData4\" onclick='saveDataLain()'>".$_SESSION['lang']['save']."</button></td></tr>";
$contentFrame[3] .= "</table></fieldset>";

## Detail Tab
$detailHeader = array($_SESSION['lang']['list'],$_SESSION['lang']['sebaran']);
$detailContent = array();
$detailContent[0] = "<div id='LainList'></div>"; 
...
$detailContent[1] .= "<tr><td colspan=2>Tahun Budget</td>";
$detailContent[1] .= "<td colspan=9>".
	makeElement("tahunBgt3L","textnum",date('Y'),array('maxlength'=>4,'style'=>'width: 70px')).
	makeElement("tahunBgt3BtnL","btn",'Filter',array('onclick'=>"sebaranLainnya()"))."</td></tr>";
$detailContent[1] .= "<tr>";
foreach($arrBln as $brsBulan =>$listBln) {
    $detailContent[1].="<td>".$listBln."</td>";
}
...
$detailContent[1].="<td></td></tr>
    <tr>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l1 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l2 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l3 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l4 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l5 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l6 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l7 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l8 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l9 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l10 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l11 value=1></td>
    <td><input type=text class=myinputtextnumber size=3 onkeypress=\"return angka_doang(event);\" id=s2l12 value=1></td>
    <td><img src=images/clear.png onclick=bersihkanAja('s2l'); style='height:30px;cursor:pointer' title='bersihkan'></td>
    </tr>
    </table>  ";

//$detailContent[1].="<table><tr class=rowcontent><td>".$_SESSION['lang']['kodeblok']."</td><td><select id=kdblokSebaran onchange='loadDetailTotal()'>".$optBlok."</select></td><td>".$_SESSION['lang']['noakun']."</td><td><select id=kdNoakunData onchange='loadDetailTotal()'>".$optNoakunData58."</select></td><td>Goto Page</td><td id='pagingDrop'>&nbsp;<select id='pageSebaran' onchange='loadDetailTotal()'><option value=''></option></select><span id=awalPageSebaran></span> &nbsp;".$_SESSION['lang']['dari']." &nbsp;<span id=totalPageSebaran></span></td></tr></table>";

$detailContent[1].="<div id='detailDataSebaran2L' style='overflow:auto;width:1030px;height:300px;'>
    <table cellpadding=1 cellspacing=1 border=0 class=sortable width=100%>
                <thead>
                <tr class=rowheader>
                <td></td>               
...
$resSebaran = fetchData($sLoad);*/
		...
		$ql2="select count(*) as jmlhrow from ".$dbname.".bgt_budget_detail a left join ".$dbname.".setup_kegiatan b ".
    "on a.kegiatan=b.kodekegiatan where b.kelompok in ('TB','LC','PNN','TBM','TM') and a.kodeorg like '".
        $_SESSION['empl']['lokasitugas']."%' and kodebudget='OTHER' and tipebudget='ESTATE' and tutup=0 and tahunbudget=".date('Y');
...
,a.rp02,a.rp03,a.rp04,a.rp05,a.rp06,a.rp07,a.rp08,a.rp09,a.rp10,a.rp11,a.rp12 from ".$dbname.".bgt_budget_detail a left join ".$dbname.".setup_kegiatan b ".
    "on a.kegiatan=b.kodekegiatan where b.kelompok in ('TB','LC','PNN','TBM','TM') and a.kodeorg like '".
        $_SESSION['empl']['lokasitugas']."%' and kodebudget='OTHER' and tipebudget='ESTATE' and tutup=0 and tahunbudget=".date('Y')." limit ".$offset.",".$limit." ";
...
foreach($resSebaran as $key=>$row) {
        ...
        $dtClik="onclick=\"getForm('Sebaran','<fieldset style=\'width:520px;height:400px;\'>".
                "<legend>Sebaran Per Bulan</legend><div id=containerForm style=\'overflow:auto;height:450px;".
                "width:480px\'></div><input type=hidden id=keyId2l value=\'".$row['kunci']."\'></fieldset>',".
                $row['rupiah'].",".$row['jumlah'].",'".$row['kodebudget']."',event,true);\"";
...
$detailContent[1].="
		...
		if(isset($page))
		{
			...
			if($page <=1 )
			{
				...
				$j = $page - 1;
				$detailContent[1].="<button class=mybutton onclick=cariBastSebarLain(".($j).");>".$_SESSION['lang']['pref']."</button>";
			}
			$detailContent[1].="<select name=select1L onchange=choosePageL(this);>";
			for($i=1; $i <= $totalPages; $i++)
			{
				if($i<>$page)
				{
			...
			{
			$j = $page + 1;
			$detailContent[1].="<button class=mybutton onclick=cariBastSebarLain(".($j).");>".$_SESSION['lang']['lanjut']."</button>";
			}
...
$contentFrame[3] .= "<fieldset style='float:left;clear:left'><legend>".$_SESSION['lang']['entryForm']."</legend><div id='lainDetail'>";
$contentFrame[3] .= drawTab('FRM3',$detailHeader,$detailContent,100,'100%',true);
$contentFrame[3] .= "</div></fieldset>";



$contentFrame[3] .= CLOSE_BOX2();
...
$contentFrame[4] = "<fieldset  style='float:left'><legend>".$_SESSION['lang']['tutup']."</legend>
    <div><table><tr><td>".$_SESSION['lang']['budgetyear']."</td><td><select id='thnBudgetTutup' style='width:150px'>".$optThnTtp."</select></td></tr>";
$contentFrame[4] .= "<tr><td colspan=2 align=center><button class=\"mybutton\"  id=\"saveData\" onclick='closeBudget()'>".$_SESSION['lang']['tutup']."</button></td></tr></table>";
$contentFrame[4] .= "</div></fieldset>";
################################################################################
########################################################### /Tab Tutup Budget ##
################################################################################
//echo mysql_error();

$headFrame = array("LC","Pemeliharaan","Pengangkutan dan Perawatan Mekanis","Lain Lain","Tutup");
