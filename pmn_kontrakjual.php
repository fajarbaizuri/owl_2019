...
foreach($arrKurs as $dt => $is)
{
	$optKurs.="<option value=".$dt.">".$is."</option>";
}
//=========================
$frm[0].="
<input type=hidden id=method name=method value='insert' />     <fieldset>
	  ...
	  <fieldset>
			...
			<tbody>
				...
				<td><input type=text class=myinputtextnumber  name=HrgStn id=HrgStn onchange=tambah(); onkeypress=\"return angka_doang(event);\"  style=\"width:100px;\" /></td>
				<td><select id=kurs name=kurs style=\"width:50px;\">".$optKurs."</select></td>
				<td><input type=text class=myinputtextnumber name=jmlh id=jmlh onchange=tambah(); onkeypress=\"return angka_doang(event);\" style=\"width:100px;\" /></td>
				<td><input type=text class=myinputtextnumber  name=total id=total onkeypress=\"return angka_doang(event);\"  onblur=\"rupiahkan(this,'tBlg')\" style=\"width:100px;\" /></td>
			...
			<tbody>
				...
				<td><input type=text class=myinputtextnumber name=tlransi id=tlransi style=\"width:150px;\"  /></td>
