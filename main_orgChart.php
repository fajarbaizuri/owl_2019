...
echo"<div id=inputorg style='display:none;position:absolute'>
		...
		<table>
		<tr>
		   <td>".$_SESSION['lang']['orgcode']."</td><td><input type=text class=myinputtext id=orgcode maxlength=10 size=12 onkeypress=\"return charAndNum(event);\"></td>
		</tr>
		<tr>
		   <td>".$_SESSION['lang']['orgname']."</td><td><input type=text class=myinputtext id=orgname maxlength=45 size=100 onkeypress=\"return charAndNumAndStrip(event);\"></td>
		</tr>	
		<tr>
		   <td>".$_SESSION['lang']['orgtype']."</td><td><select id=orgtype>".$optTipeOrg."</select></td>
		</tr>
		<tr>
		   <td>".$_SESSION['lang']['detail']."</td><td><select id=orgdetail><option value=1>".$_SESSION['lang']['yes']."</option><option value=0>".$_SESSION['lang']['no']."</option></select></td>
		</tr>		
		<tr>
