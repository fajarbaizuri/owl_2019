...
OPEN_BOX('',"<b>Kondisi lapangan TBM</b>");
?>
...
<script language="javascript" src="js/kebun_qc_kondTBM.js"></script>
...
$sPeriode="select distinct substr(tanggal,1,7) as periode from ".$dbname.".kebun_qc_kondisitbmht where afdeling like '".$_SESSION['empl']['lokasitugas']."%'";
...
<td align=center>Piringan</td>
<td align=center>Gawangan</td>
<td align=center>Pemupukan</td>
<td align=center>HPT</td>
