...
$frm[0]="<fieldset>
	 ...
	 </fieldset>";//<img onclick=fisikKePDF(event,'kebun_laporanPanen_pdf.php') title='PDF' class=resicon src=images/pdf.jpg>
	 ...
	 <div style='width:100%;height:359px;overflow:scroll;'>
       <table class=sortable cellspacing=1 border=0 width=100%>
	     <thead>
			...
			<td align=center>BJR Aktual (Kg)</td>    
...
$frm[2].="</fieldset>";//<img onclick=laporanKePDF_2(event,'kebun_laporanPanen_orang_pdf.php') title='PDF' class=resicon src=images/pdf.jpg>
