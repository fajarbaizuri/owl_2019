...
<script language="javascript" src="js/kebun_qc_pemeriksaanBuah.js"></script>
...
$sPeriode="select distinct substr(tanggal,1,7) as periode from ".$dbname.".kebun_qc_panenht where kodeorg like '".$_SESSION['empl']['lokasitugas']."%'";
...
<td align=center>No.TPH</td>
<td align=center>JJg Diperiksa</td>
<td align=center>Mentah</td>
<td align=center>Kurang Matang</td>
<td align=center>Matang</td>
<td align=center>Lwt Matang</td>
<td align=center>Tangkai panjang</td>
...
<td>:</td>
<td>
<select id=\"idMandor1\" name=\"idMandor1\" style=\"width:120px;\">".$optMandor."</select>
</td>
</tr>
<tr>
...
<td>:</td>
<td>
<select id=\"idMandor2\" name=\"idMandor2\" style=\"width:120px;\" >".$optMandor."</select>
</td>
</tr>
<tr>
<td>Pemeriksa</td>
<td>:</td>
<td>
<select id=\"idPemeriksa\" name=\"idPemeriksa\" style=\"width:120px;\" >".$optMandor."</select>
    </td>
    <td>&nbsp;</td>
<td>".$_SESSION['lang']['mandor']." ".$_SESSION['lang']['panen']." 3</td>
<td>:</td>
<td>
<select id=\"idMandor3\" name=\"idMandor3\" style=\"width:120px;\" >".$optMandor."</select>
</td>
</tr>
...
echo"<td><select id=karyawnId style=\"width:120px;\">".$optKary."</select></td>";
echo"<td><select id=noTph style=\"width:120px;\">".$optKary."</select></td>";
echo"<td><input type=text id=jjgPriksa name=jjgPriksa onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
echo"<td><input type=text id=mnth name=mnth onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
echo"<td><input type=text id=krgMtng name=krgMtng onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
echo"<td><input type=text id=mtng name=mtng onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
echo"<td><input type=text id=lwtMtng name=lwtMtng onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
echo"<td><input type=text id=tngkiPnjng name=tngkiPnjng onkeypress='return angka_doang(event)' class=myinputtextnumber  style=\"width:150px;\" /></td>";
