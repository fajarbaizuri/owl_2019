...
while($rOrg=mysql_fetch_assoc($qOrg))
{
	$optOrg.="<option value=".$rOrg['kodeorganisasi'].">".$rOrg['namaorganisasi']."</option>";
		...
		$str="SELECT kodekegiatan,concat(kodekegiatan,':',namakegiatan ) as nama FROM  ".$dbname.".`setup_kegiatan` where kelompok NOT in ('MIL','KNT','PNN') order by kodekegiatan asc";
...
<script language=javascript src='js/lha_new.js'></script>

<link rel=stylesheet type=text/css href=style/zTable.css>
<div>
<fieldset style="float: left;">
<legend><b><?php echo "Lap. Harian - Pemeliharaan"; ?></b></legend>
...
<tr><td><label><?php echo "Kegiatan"?></label></td><td><select id="kdKeg" name="kdKeg" style="width:150px"><?php echo $optKeg?></select></td></tr>
...
<tr><td colspan="2">
    <button onclick="zPreview('lha_slave_print_new','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="html">Preview</button>
