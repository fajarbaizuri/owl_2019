...
$s_realstbi ="select left(kodeblok,6) as blok,sum(jumlah) as realst from ".$dbname.".keu_jurnaldt_vw
              where noakun like '63102%' and kodeblok like '".$kdOrg."%' and tanggal like '".$periode."%' group by left(kodeblok,6)";
//echo $s_realstbi;
...
$s_budstbi="select left(kodeorg,6) as kode,sum(rp".$bulan.") as budget_st from ".$dbname.".bgt_budget_detail
            where noakun like '63102%' and kodeorg like '".$kdOrg."%' and tahunbudget='".substr($periode,0,4)."' 
...
$s_realstsdbi ="select left(kodeblok,6) as kdblok,sum(jumlah) as realst_sdbi from ".$dbname.".keu_jurnaldt_vw
                where noakun like '63102%' and kodeblok like '".$kdOrg."%' and tanggal between '".$thn[0]."-01-01' and LAST_DAY('".$periode."-15') 
