...
$frm[0].="</fieldset>";
$frm[0].="<fieldset style='width:300px;'><legend>Sumber</legend><table cellspacing=1 border=0>";
...
$frm[0].="<tr><td>Diterima ".$_SESSION['lang']['kebun']."</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlhTrima' onkeypress='return angka_doang(event)' value='0' /></td></tr>";
$frm[0].="<tr><td>Afkir Kecambah</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='afkirKcmbh' onkeypress='return angka_doang(event)' value='0' /></td></tr>";
...
$frm[3].="<input type='hidden' id='proses2' value='saveTab2' /><fieldset style=width:650px;><legend>".$_SESSION['lang']['transplatingbibit']."</legend>
   <fieldset style='text-align:left;width:300px;float:right;'>
				   ...
				   <p>Termasuk Pemindahan dari PN ke PN tempat lain, maupun ke MN tempat lain 
				   </p>
				   </fieldset>	
...
<tr><td>".$_SESSION['lang']['jumlah']."</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlhTpBbtn' onkeypress='return angka_doang(event)' value='0' />&nbsp;Bibit</td></tr>
...
<tr><td>".$_SESSION['lang']['jumlah']."</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlhAfk' onkeypress='return angka_doang(event)' value='0' />&nbsp;Bibit</td></tr>
...
<tr><td>".$_SESSION['lang']['jumlah']."</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlhDbt' onkeypress='return angka_doang(event)' value='0' />&nbsp;Bibit</td></tr>
...
foreach($arr as $isi =>$eia)
{
 ...
 $sKaryawan="select distinct karyawanid,namakaryawan from ".$dbname.".datakaryawan where lokasitugas='".$_SESSION['empl']['lokasitugas']."' and sistemgaji='BULANAN' and karyawanid!='".$_SESSION['standard']['userid']."'";
...
<tr><td>".$_SESSION['lang']['batch']."</td><td>:</td><td><select id='batchPnb' style=width:150px onchange='getKodeorg7()'>".$optbatch."</select></td></tr>
...
<tr><td>".$_SESSION['lang']['kodeorg']."</td><td>:</td><td><select id='kdOrgPnb' style=width:150px>".$optKdorg."</select></td></tr>
<tr><td>".$_SESSION['lang']['jumlah']."</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlhPnb' onkeypress='return angka_doang(event)' value='0' />&nbsp;Bibit</td></tr>
<tr><td>".$_SESSION['lang']['keterangan']."</td><td>:</td><td><input type='text' class='myinputtext'  style='width:150px;' id='ketPnb' onkeypress='return tanpa_kutip(event)' maxlength=45 /></td></tr>";
...
<tr><td>Rit Ke</td><td>:</td><td><input type='text' class='myinputtextnumber'  style='width:150px;' id='jmlRit' onkeypress='return angka_doang(event)' maxlength=20 /></td></tr>
...
<tr><td>".substr($_SESSION['lang']['customerlist'],4)."</td><td>:</td><td><select id='custId' style=width:150px onchange='getKodeorgAfd(0,0)'>".$optKode."</select></td></tr>
<tr><td>".$_SESSION['lang']['afdeling']."</td><td>:</td><td><select id='kdAfdeling' style=width:150px disabled >".$optAfd."</select></td></tr>   
<tr><td>".$_SESSION['lang']['lokasi']." ".substr($_SESSION['lang']['detailPengiriman'],6)."</td><td>:</td><td><input type='text' class='myinputtext'  style='width:150px;' id='detPeng' onkeypress='return tanpa_kutip(event)' maxlength=45 /></td></tr>
...
$frm[4].="<fieldset><legend>".$_SESSION['lang']['datatersimpan']."</legend>
    <table cellpadding=1 cellspacing=1 border=0 class=sortable>
            ...
            <td>".substr($_SESSION['lang']['customerlist'],4)."</td>
