...
echo open_body();
?>
<script language=javascript1.2 src="js/keu_lap_ian.js"></script>
<?
...
<legend><b><?php echo $_SESSION['lang']['rincianbb']?></b></legend>
...
*/
echo"<span id=printPanel style='display:none;'>
     <img onclick=jurnalv1KeExcel(event,'keu_laporanBukuBesarvIAN_Excel.php') src=images/excel.jpg class=resicon title='MS.Excel'> 
	 <img onclick=jurnalv1KePDF(event,'keu_laporanBukuBesarvIAN_pdf.php') title='PDF' class=resicon src=images/pdf.jpg>
	 </span>    
	 <div style='width:100%;height:359px;overflow:scroll;'>
