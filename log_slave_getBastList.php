...
//==================
  ...
  while($bar=mysql_fetch_object($res))
  {
	...
	if($bar->post<1)
	{
		...
		$add="<img src=images/application/application_edit.png class=resicon  title='Edit' onclick=\"editXBast('".$bar->notransaksi."','".$bar->untukunit."','".tanggalnormal($bar->tanggal)."','".$bar->namapenerima."','".$bar->keterangan."');\">";
