...
if($cekapa=='tab0'){
	...
	#untuk total tab 0
	$totalvolume0+=$bar->volume;
	$totaljumlah0+=$bar->jumlah;
	$totalbiaya0+=$bar->rupiah;
	
    }
	$hkef.="
	<thead><tr class=rowcontent class=sortable cellspacing=1>
		<td colspan=5 align=center>Total</td>
		<td align=right>".number_format($totalvolume0)."</td>
		<td></td>
		<td align=right>".number_format($totaljumlah0)."</td>
		<td></td>
		<td align=right>".number_format($totalbiaya0)."</td>
		<td></td>
	</tr>";
    echo $hkef;        
...
//kamus namabarang
	...
	$totaljumla1+=$bar->jumlah;
	$totalrupiah1+=$bar->rupiah;
	
    }
	$hkef.="
	<thead><tr class=rowcontent class=sortable cellspacing=1>
		<td colspan=7 align=center>Total</td>
		<td align=right>".number_format($totaljumla1)."</td>
		<td></td>
		<td align=right>".number_format($totalrupiah1)."</td>
		<td></td>
	</tr>";
    echo $hkef;        
...
//kamus namabarang
	...
	$totaljumla2+=$bar->jumlah;
	$totalrupiah2+=$bar->rupiah;
    
	}
	$hkef.="
	<thead><tr class=rowcontent class=sortable cellspacing=1>
		<td colspan=7 align=center>Total</td>
		<td align=right>".number_format($totaljumla2)."</td>
		<td></td>
		<td align=right>".number_format($totalrupiah2)."</td>
		<td></td>
	</tr>";	
    echo $hkef;        
...
//kamus namaakun
    ...
    $no+=1;
	$totalrupiah3+=$bar->rupiah;
    }
	$hkef.="
	<thead><tr class=rowcontent class=sortable cellspacing=1>
		<td colspan=7 align=center>Total</td>
		<td align=right>".number_format($totalrupiah3)."</td>
		<td></td>
...
//    }
	...
	$totalvolume4+=$bar->volume;
	$totaljumlah4+=$bar->jumlah;
	$totalrupiah4+=$bar->rupiah;
	...
	<thead><tr class=rowcontent class=sortable cellspacing=1>
		...
		<td align=right>".number_format($totalvolume4)."</td>
		<td></td>
		<td align=right>".number_format($totaljumlah4)."</td>
		<td align=right>".number_format($totalrupiah4)."</td>
