...
$sPabrik="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where tipe='KEBUN' and kodeorganisasi like '___E'";
...
<legend><b>LAPORAN KINERJA EVALUASI TENAGA PANEN</b></legend>
...
<tr><td colspan="2"><button onclick="zPreview('kebun_slave_2evaluasi_tenaga','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['preview']?></button>



<button onclick="zExcel(event,'kebun_slave_2evaluasi_tenaga.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview"><?php echo $_SESSION['lang']['excel']?></button>
