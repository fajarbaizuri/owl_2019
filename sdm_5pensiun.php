...
echo open_body();
?> 
<script language=javascript1.2 src='js/sdm_payrollPENSIUN.js'></script>
...
while($bar=mysql_fetch_object($res))
   {
    if($bar->id=='karpensiun')
        $kar=$bar->value;
    if($bar->id=='perpensiun')
        $prsh=$bar->value;
   }
        
//+++++++++++++++++++++++++++++++++++++++++++++
	OPEN_BOX('','<b>PENSIUN SETUP:</b>');
	    echo"<div id=period>";
