...
$where = "`tipe`='HOLDING' or `tipe`='PABRIK' or `tipe`='KANWIL' or `tipe`='GUDANG'".
	" or `tipe`='KEBUN' or `tipe`='TRAKSI' or `tipe`='LINE'";
...
$els['btn'] = array(
  genFormBtn($fieldStr,
    'setup_periodeakuntansi',"##kodeorg##periode",null,null,null,null,'##tutupbuku')
);

# Generate Field
echo genElTitle('Periode Akuntansi',$els);
echo "</div>";
#=======End Form============
