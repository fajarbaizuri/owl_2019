...
//param+='&kdUnit='+kdUnit;
        ...
        thnBudgetHead=document.getElementById('thndBudgetHead').options[document.getElementById('thndBudgetHead').selectedIndex].value;
        kdVhcHead=document.getElementById('kdVhcHead').options[document.getElementById('kdVhcHead').selectedIndex].value;
        kdUnitHead=document.getElementById('kdUnitHead').options[document.getElementById('kdUnitHead').selectedIndex].value;
        if(thnBudgetHead!='')
        {
            param+='&thnBudgetHead='+thnBudgetHead;
        }
        if(kdVhcHead!='')
        {
            param+='&kdVhcHead='+kdVhcHead;
        }
        if(kdUnitHead!='')
        {
            param+='&kdUnitHead='+kdUnitHead;
        }
       // alert(param);
	tujuan='budget_slave_total_jam_vhc.php';
	post_response_text(tujuan, param, respog);
...
//    document.getElementById('tmblSave').innerHTML="<button onclick='saveHead2()' class='mybutton' name='saveDt' id='saveDt'>"+save+"</button>&nbsp;<button onclick='batal()' class='mybutton' name='btl' id='btl'>"+btl+"</button>";
}
