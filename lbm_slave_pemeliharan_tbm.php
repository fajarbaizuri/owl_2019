...
$tab.="<table border=0>
     <tr>
        <td colspan=15 align=left><font size=3>11. PEMELIHARAAN TBM (HA-HK)</font></td>
...
switch($proses)
{
    ...
    $dte=date("YmdHis");
    $nop_="lbm_pemeliharan_tbm_".$unit.$periode;
    if(strlen($tab)>0)
    {
    ...
    function Header() {
        ...
        $this->Cell($width/2,$height,'11. PEMELIHARAAN TBM (HA-HK) ',NULL,0,'L',1);
