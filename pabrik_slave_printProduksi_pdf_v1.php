...
//================================
	...
	// echo $ha;
		 ...
		 $hu=mysql_fetch_assoc($hi);
			...
			//echo $tbsolahrt.__.$oercpoolahrt.____.$oerkernelolahrt;exit();
				$oercpopersenrt=($oercpoolahrt/$tbsolahrt)*100;
				$oerkernelpersenrt=($oerkernelolahrt/$tbsolahrt)*100;
		$pdf->Cell(130,5,'Rata - Rata',1,0,'C');		
		$pdf->Cell(15,5,number_format($oercpopersenrt,2),1,0,'R');
		$pdf->Cell(85,5,' ',1,0,'C');
		$pdf->Cell(15,5,number_format($oerkernelpersenrt,2),1,0,'R');
