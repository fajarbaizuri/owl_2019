...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING')$sPeriode="select distinct periode from ".$dbname.".sdm_5periodegaji order by periode desc";
else{
...
<tr><td colspan="2"><button onclick="zPreview('sdm_slave_2potongan_pendapatan','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zPdf('sdm_slave_2potongan_pendapatan','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button><button onclick="zExcel(event,'sdm_slave_2potongan_pendapatan.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview">Excel</button><button onclick="Clear1()" class="mybutton" name="btnBatal" id="btnBatal"><?php echo $_SESSION['lang']['cancel']?></button></td></tr>
...
<div >
<fieldset style="float: left;">
<legend><b><?php echo $_SESSION['lang']['lapPotongan']?> Per Karyawan</b><?php //echo $_SESSION['lang']['']?></legend>
<table cellspacing="1" border="0" >
...
<tr><td colspan="2"><button onclick="zPreview('sdm_slave_2potongan_pendapatan_kary','<?php echo $arrKry?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zPdf('sdm_slave_2potongan_pendapatan_kary','<?php echo $arrKry?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button><button onclick="zExcel(event,'sdm_slave_2potongan_pendapatan_kary.php','<?php echo $arrKry?>')" class="mybutton" name="preview" id="preview">Excel</button><button onclick="Clear2()" class="mybutton" name="btnBatal" id="btnBatal"><?php echo $_SESSION['lang']['cancel']?></button></td></tr>
</table>
</fieldset>
</div>
