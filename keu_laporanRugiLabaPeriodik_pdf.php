...
//        $this->Line(10,36,200,36);
        ...
        $this->Cell($lebarisi,5,'Jan','B',0,'R');
        $this->Cell($lebarisi,5,'Feb','B',0,'R');
        $this->Cell($lebarisi,5,'Mar','B',0,'R');
        $this->Cell($lebarisi,5,'Apr','B',0,'R');
        $this->Cell($lebarisi,5,'May','B',0,'R');
        $this->Cell($lebarisi,5,'Jun','B',0,'R');
        $this->Cell($lebarisi,5,'Jul','B',0,'R');
        $this->Cell($lebarisi,5,'Aug','B',0,'R');
        $this->Cell($lebarisi,5,'Sep','B',0,'R');
        $this->Cell($lebarisi,5,'Oct','B',0,'R');
        $this->Cell($lebarisi,5,'Nov','B',0,'R');
        $this->Cell($lebarisi,5,'Dec','B',0,'R');
