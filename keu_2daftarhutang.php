...
$arrOpt=array("0"=>"Belum Lunas","1"=>"Sudah Lunas");
...
<tr><td><label><?php echo $_SESSION['lang']['dari']." ".$_SESSION['lang']['periode']?></label></td><td><select id='periode' style="width:150px"><?php echo $optper?></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['tglcutisampai']." ".$_SESSION['lang']['periode']?></label></td><td><select id='periode2' style="width:150px"><?php echo $optper?></select></td></tr>
