...
//header
$jjgKrm=isset($_POST['jjgKrm'])?$_POST['jjgKrm']:'';
$umrRestan=isset($_POST['umrRestan'])?$_POST['umrRestan']:'';
$kdBlokRestan=isset($_POST['kdBlokRestan'])?$_POST['kdBlokRestan']:'';
$jjgPanen=isset($_POST['jjgPanen'])?$_POST['jjgPanen']:'';
$cttn=isset($_POST['cttn'])?$_POST['cttn']:'';
$tglRestan=isset($_POST['tglRestan'])?tanggalsystem($_POST['tglRestan']):'';
...
$kdBlokCari=isset($_POST['kdBlokCari'])?$_POST['kdBlokCari']:'';
$periodeCari=isset($_POST['periodeCari'])?$_POST['periodeCari']:'';


//$arr="##kdUnit##afdId##BlokId##periodeId";
isset($_POST['kdUnit']) and $_POST['kdUnit']==''?$kdUnit=$_GET['kdUnit']:$kdUnit=$_POST['kdUnit'];
isset($_POST['afdId']) and $_POST['afdId']==''?$afdId=$_GET['afdId']:$afdId=$_POST['afdId'];
isset($_POST['BlokId']) and $_POST['BlokId']==''?$BlokId=$_GET['BlokId']:$BlokId=$_POST['BlokId'];
isset($_POST['periodeId']) and $_POST['periodeId']==''?$periodeId=$_GET['periodeId']:$periodeId=$_POST['periodeId'];
