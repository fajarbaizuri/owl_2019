...
<tr><td><label>TBS</label></td><td><select id=\"tipeIntex\" name=\"tipeIntex\" onchange=\"getKode()\" style=\"width:150px\">".$optTbs."</select></td></tr>
...
$frm[2].="<fieldset><legend>Trend Produksi</legend>";
...
$hfrm[1]='Produksi Detail';
$hfrm[2]='Trend Produksi';
