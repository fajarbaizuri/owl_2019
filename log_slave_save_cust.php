<?php
	...
	switch($method){
		...
		,noseri='".$noseri."',klcustomer='".$klcustomer."',fax='".$fax."'
		...
		(`kodecustomer`, `namacustomer`, `alamat`, `kota`, `telepon`, `kontakperson`, `akun`, `plafon`, `nilaihutang`, `npwp`, `noseri`, `klcustomer`,`fax`)
		values
		('".$kodecustomer."','".$namacustomer."','".$alamat."','".$kota."','".$telepon."','".$kontakperson."','".$akun."','".$plafon."','".$nilaihutang."','".$npwp."','".$noseri."','".$klcustomer."','".$fax."')";// echo $strx; exit();
