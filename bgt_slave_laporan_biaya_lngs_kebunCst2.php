...
//GET NOAKUN
$sNoakun="select distinct kegiatan from ".$dbname.".bgt_budget_kegiatan_vw where tipebudget='ESTATE' and kodebudget!='UMUM' and tahunbudget='".$thnBudget."' and afdeling like '".$kodeOrg."%' order by kegiatan asc";
//exit("Error".$sNoakun);
...
$sTotAkun="select sum(rupiah) as total,substr(kegiatan,1,5) as akunkpla from ".$dbname.".bgt_budget_kegiatan_vw  where  afdeling like '".$kodeOrg."%' and tahunbudget='".$thnBudget."'  group by akunkpla";
//exit("Error".$sTotAkun);
...
$sTotAkun2="select sum(rupiah) as total,kegiatan,substr(kegiatan,1,5) as kepalaAkn from ".$dbname.".bgt_budget_kegiatan_vw  where  afdeling like '".$kodeOrg."%' and tahunbudget='".$thnBudget."'  group by kegiatan";
//exit("Error".$sTotAkun);
...
if($kodeOrg==''||$thnBudget=='')
{
    exit("Error:Field Tidak Boleh Kosong");
            ...
            $tab.="<td  rowspan=5 valign='middle' align=center ".$bg." >".$_SESSION['lang']['luas']."</td>";
            ...
            foreach($listNoakun as $barisNoakun)
            {
                 ...
                 $new=substr($barisNoakun,0,5);
//                if($ktKrgng!='' and $ktKrgng!=$new)
//                {
//                    $ktKrgng=substr($barisNoakun,0,5);
//                    $tab.="<thead><tr class=rowheader><td align=right>".$ktKrgng."</td><td align=right>".$optKegiatan[$ktKrgng]."</td>";
//                    
//                    if(substr($ktKrgng,0,1)!=6)
//                    {
//                        if($ktKrgng=='12601')
//                        {
//                        @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuasLc;
//                        @$bagiKplaSdm=$totalKplaSDM[$thnBudget][$ktKrgng][sdm]/$ttlLuasLc;
//                        @$bagiKplaMat=$totalKplaSDM[$thnBudget][$ktKrgng][mat]/$ttlLuasLc;
//                        @$bagiKplaTool=$totalKplaSDM[$thnBudget][$ktKrgng][tool]/$ttlLuasLc;
//                        @$bagiKplaVhc=$totalKplaSDM[$thnBudget][$ktKrgng][vhc]/$ttlLuasLc;
//                        @$bagiKplaKntrk=$totalKplaSDM[$thnBudget][$ktKrgng][kntrk]/$ttlLuasLc;
//                        $pembagi[$ktKrgng]=$ttlLuasLc;                         
//                        }
//                        else if(substr($ktKrgng,0,3)=='128')
//                        {
//                            
//                            @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuasPkk;
//                            @$bagiKplaSdm=$totalKplaSDM[$thnBudget][$ktKrgng][sdm]/$ttlLuasPkk;
//                            @$bagiKplaMat=$totalKplaSDM[$thnBudget][$ktKrgng][mat]/$ttlLuasPkk;
//                            @$bagiKplaTool=$totalKplaSDM[$thnBudget][$ktKrgng][tool]/$ttlLuasPkk;
//                            @$bagiKplaVhc=$totalKplaSDM[$thnBudget][$ktKrgng][vhc]/$ttlLuasPkk;
//                            @$bagiKplaKntrk=$totalKplaSDM[$thnBudget][$ktKrgng][kntrk]/$ttlLuasPkk;
//                            $pembagi[$ktKrgng]=$ttlLuasPkk;   
//                                               
//                        }
...
//                            @$bagiKplaSdm=$totalKplaSDM[$thnBudget][$ktKrgng][sdm]/$ttlLuastbm;
//                            @$bagiKplaMat=$totalKplaSDM[$thnBudget][$ktKrgng][mat]/$ttlLuastbm;
//                            @$bagiKplaTool=$totalKplaSDM[$thnBudget][$ktKrgng][tool]/$ttlLuastbm;
//                            @$bagiKplaVhc=$totalKplaSDM[$thnBudget][$ktKrgng][vhc]/$ttlLuastbm;
//                            @$bagiKplaKntrk=$totalKplaSDM[$thnBudget][$ktKrgng][kntrk]/$ttlLuastbm;
...
//                        $pembagi[$ktKrgng]=$ttlLuastm;   
//                        @$bagiKplaSdm=$totalKplaSDM[$thnBudget][$ktKrgng][sdm]/$ttlLuastm;
//                        @$bagiKplaMat=$totalKplaSDM[$thnBudget][$ktKrgng][mat]/$ttlLuastm;
//                        @$bagiKplaTool=$totalKplaSDM[$thnBudget][$ktKrgng][tool]/$ttlLuastm;
//                        @$bagiKplaVhc=$totalKplaSDM[$thnBudget][$ktKrgng][vhc]/$ttlLuastm;
//                        @$bagiKplaKntrk=$totalKplaSDM[$thnBudget][$ktKrgng][kntrk]/$ttlLuastm;
//                        $awal=0;
//                      }
//                      
//                    }
////                    $tab.="<td align=right>".number_format($totRupiah[$thnBudget][$ktKrgng],2)."</td>";
//                        $tab.="<td align=right>".number_format($pembagi[$ktKrgng],2)."</td>";
//                        $tab.="<td align=right>".number_format($totBagi,2)."</td>";
//                        $tab.="<td align=right>".number_format($totalKplaSDM[$thnBudget][$ktKrgng][sdm],2)."</td>";
//                        $tab.="<td align=right>".number_format(($bagiKplaSdm),2)."</td>";
//                        $tab.="<td align=right>".number_format($totalKplaSDM[$thnBudget][$ktKrgng][mat],2)."</td>";
//                        $tab.="<td align=right>".number_format(($bagiKplaMat),2)."</td>";
//                        $tab.="<td align=right>".number_format($totalKplaSDM[$thnBudget][$ktKrgng][tool],2)."</td>";
//                        $tab.="<td align=right>".number_format(($bagiKplaTool),2)."</td>";
//                        $tab.="<td align=right>".number_format($totalKplaSDM[$thnBudget][$ktKrgng][vhc],2)."</td>";
//                        $tab.="<td align=right>".number_format(($bagiKplaVhc),2)."</td>";
//                        $tab.="<td align=right>".number_format($totalKplaSDM[$thnBudget][$ktKrgng][kntrk],2)."</td>";
//                        $tab.="<td align=right>".number_format(($bagiKplaKntrk),2)."dsadasdasdsadsa</td>";
//                     $tab.="</tr></thead>"; 
//                }
                    if(substr($new,0,1)!=6)
                    {
                       
                        if(substr($new,0,5)=='12601')
                       {
                            $pembagi[$barisNoakun]=$ttlLuasLc;    
                       }
                       else if(substr($new,0,3)=='128')
                       {
                            $pembagi[$barisNoakun]=$ttlLuasPkk;    
                       }
                       else if(substr($new,0,5)>='12602')
                       {
                            $pembagi[$barisNoakun]=$ttlLuastbm;    
                       }
                    }
                    else if(substr($new,0,1)=='6')
                    {
                        $pembagi[$barisNoakun]=$ttlLuastm;
                    }
                    $new2=substr($new,0,3);
                    @$kegHa[$thnBudget][$barisNoakun][$new]=$totRupiahKegiatan[$thnBudget][$barisNoakun][$new]/$pembagi[$barisNoakun];
                    @$kegSdm[$thnBudget][$barisNoakun][$new]=$dataKeg[$thnBudget][$barisNoakun][$new2][sdm]/$pembagi[$barisNoakun];
                    @$kegMat[$thnBudget][$barisNoakun][$new]=$dataKeg[$thnBudget][$barisNoakun][$new2][mat]/$pembagi[$barisNoakun];
                    @$kegTool[$thnBudget][$barisNoakun][$new]=$dataKeg[$thnBudget][$barisNoakun][$new2][tool]/$pembagi[$barisNoakun];
                    @$kegVhc[$thnBudget][$barisNoakun][$new]=$dataKeg[$thnBudget][$barisNoakun][$new2][vhc]/$pembagi[$barisNoakun];
                    @$kegKntrak[$thnBudget][$barisNoakun][$new]=$dataKeg[$thnBudget][$barisNoakun][$new2][kntrk]/$pembagi[$barisNoakun];
                    $tab.="<tr class='rowcontent'>";
                    $tab.="<td><b>".$barisNoakun."</b></td><td><b>".$optKegiatan[$barisNoakun]."</b></td>";
                    $tab.="<td align=right>".number_format($pembagi[$barisNoakun],2)."</td>";
                    ...
                    $tab.="<td align=right>".number_format($dataKeg[$thnBudget][$barisNoakun][$new2][sdm],2)."</td>";
                    $tab.="<td align=right>".number_format($kegSdm[$thnBudget][$barisNoakun][$new],2)."</td>";
                    $tab.="<td align=right>".number_format($dataKeg[$thnBudget][$barisNoakun][$new2][mat],2)."</td>";
                    $tab.="<td align=right>".number_format($kegMat[$thnBudget][$barisNoakun][$new2],2)."</td>";
                    $tab.="<td align=right>".number_format($dataKeg[$thnBudget][$barisNoakun][$new2][tool],2)."</td>";
                    $tab.="<td align=right>".number_format($kegTool[$thnBudget][$barisNoakun][$new],2)."</td>";
                    $tab.="<td align=right>".number_format($dataKeg[$thnBudget][$barisNoakun][$new2][vhc],2)."</td>";
                    $tab.="<td align=right>".number_format($kegVhc[$thnBudget][$barisNoakun][$new],2)."</td>";
                    $tab.="<td align=right>".number_format($dataKeg[$thnBudget][$barisNoakun][$new2][kntrk],2)."</td>";
...
//            $tab.="<tr class='rowheader'><td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." TBM</td>";
//            }
//            else if($ktKrgng=='128')
//            {
//                 @$totBagi=0;
//                 $ttlLuastbm=0;
//                $tab.="<tr class='rowheader'><td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." BIBITAN</td>";
//            }
//            else if($ktKrgng=='6')
//            {
//                 @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuastm;
//                 $ttlLuastbm=$ttlLuastm;
//                $tab.="<tr class='rowheader'><td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." TM</td>";
//            }
//          / $tab.="<tr class='rowheader'>";
//           if(substr($ktKrgng,0,1)!='6')
//           {
//               if(substr($ktKrgng,0,5)=='12601')
//               {
//                    @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuasLc;
//                    $ttlLuastbm=$ttlLuasLc;
//                    $tab.="<td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." LC</td>";
//               }
//               else if(substr($ktKrgng,0,3)=='128')
//               {
//                    @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuasPkk;
//                    $ttlLuastbm=$ttlLuasPkk;
//                    $tab.="<td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." BIBITAN</td>";   
//               }
//               else if(substr($ktKrgng,0,5)>='12602')
//               {
//                    @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuastbm;
//                    $ttlLuastbm=$ttlLuastbm;
//                    $tab.="<td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." TBM</td>";
//               }
//           }
...
//                    @$totBagi=$totRupiah[$thnBudget][$ktKrgng]/$ttlLuastm;
//                    $ttlLuastbm=$ttlLuastm;
//                    $tab.=" <td>&nbsp;</td><td align=right colspan=2>".$_SESSION['lang']['total']." TM</td>";
//           }
...
//            $tab.="</tr>";  
//            $tab.="<tr class='rowheader'>";
//            $tab.="<td>&nbsp;</td><td colspan=2 align=right>".$_SESSION['lang']['grnd_total']."</b></td>";
