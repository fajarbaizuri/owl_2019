...
<script language=javascript1.2 src='js/sdm_potongan.js'></script>
...
$ctl[] = "<fieldset><legend><b>".$_SESSION['lang']['find']."</b></legend>".
    makeElement('sNoTrans','label',$_SESSION['lang']['keterangan']).
...
$query = selectQuery($dbname,'sdm_potonganht',$cols,"kodeorg='".$_SESSION['empl']['lokasitugas']."'","",false,10,1);
$data = fetchData($query);
$totalRow = getTotalRow($dbname,'sdm_potonganht');
...
# Title & Control
OPEN_BOX();
echo "<div align='center'><h3>".$_SESSION['lang']['potongan']."</h3></div>";
