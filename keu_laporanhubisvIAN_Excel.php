...
$view="<table border=1>
		 <thead>
		 <tr>
		 <td align=center colspan=7 ><b>Hubungan Istimewa (R/I)</b></td>
		 </tr>";
		 if(($unit1=='')&&($unit2=='')){
		// untuk pilihan semua unit1 & unit2
		$view.="<tr><td align=center colspan=7 >".$crPT[$pt]."(".$pt.") - ".$crPT[$pt2]."(".$pt2.")</td></tr>";
		}else if(($unit1=='')&&($unit2!='')){
		// untuk pilihan semua unit1 & unit2 pilihan tertentu;
		$view.="<tr><td align=center colspan=7 >".$crPT[$pt]."(".$pt.") - ".$crPT[$unit2]."(".$unit2.")</td></tr>";
		}else if(($unit1!='')&&($unit2=='')){
		// untuk pilihan semua unit2 & unit1 pilihan tertentu;
		$view.="<tr><td align=center colspan=7 >".$crPT[$unit1]."(".$unit1.") - ".$crPT[$pt2]."(".$pt2.")</td></tr>";
		}else if($unit1==$unit2){
