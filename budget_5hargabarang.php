...
echo"</fieldset>";
echo"<fieldset style='float:left;'><legend>".$_SESSION['lang']['edit']."</legend>";
    echo"<table><tr>";
    ...
    echo "<tr><td>".$_SESSION['lang']['hargasatuan']."</td><td><input type=text id=hargasatuan1 size=20 maxlength=10 class=myinputtext onkeypress=\"return angka_doang(event);\"></td></tr>";
