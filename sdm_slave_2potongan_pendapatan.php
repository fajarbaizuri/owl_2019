...
//			$where2=" and nik in (select karyawanid from ".$dbname.".datakaryawan where tipekaryawan in (1,2,3,4)  ".$where." ".$wherez."  group by karyawanid)";
...
*/
	if($kolomPotongan>10)
	{
		echo"warning: Data PDF terlalu besar, silakan gunakan Preview atau Excel untuk melihatnya.";
		exit();
	}
...
// EXCEL HEADER
	...
	<tr><td colspan='".$jumlahkolom."' align=center>".strtoupper($_SESSION['lang']['periode'])." :". tanggalnormal($tgl1)." s.d. ". tanggalnormal($tgl2)."</td></tr><tr><td colspan='".$colatas."'>&nbsp;</td></tr></table>";
