...
<fieldset style='float:left;'>
    ...
    <table cellspacing="1" border="0">
        <tr>
            ...
            <td>
                <input disabled type='text' class='myinputtext' id='index'  size='10' maxlength='30' style="width:150px;" />
            </td>
        </tr>
        <tr>
            <td><?php echo $_SESSION['lang']['tentang']?></td><td>:</td>
            <td>
                <input type='text' class='myinputtext' id='tentang' onkeypress="return tanpa_kutip();"  size='10' maxlength='30' style="width:150px;" />
            </td>
        </tr>
        <tr>
            <td><?php echo $_SESSION['lang']['modul']?></td><td>:</td>
            <td>
                <input type='text' class='myinputtext' id='modul' onkeypress="return tanpa_kutip();"  size='10' maxlength='30' style="width:150px;" />
            </td>
        </tr>
        <tr>
            <td><?php echo $_SESSION['lang']['isi']?></td><td>:</td>
            <td>
                <textarea rows="2" cols="20" id='isi' onkeypress="return tanpa_kutip();" /></textarea>
            </td>
        </tr>
...
<fieldset style='float:left;'>
    ...
    <table cellspacing="1" border="0" class="sortable">
        ...
        <tr class="rowcontent">
        <td ><input type="hidden" id="no_" name="no_" /><?php echo $no?></td>
        <td id="index_<?php echo $row['kode']?>" align="center" value="<?php echo $row['kode']?>"><?php echo $row['kode']?></td>
        <td id="modul_<?php echo $row['kode']?>" align="left" value="<?php echo $row['modul']?>"><?php echo $row['modul']?></td>
        <td id="tentang_<?php echo $row['kode']?>" align="left" value="<?php echo $row['tentang']?>"><?php echo $row['tentang']?></td>
        ...
        <?php 
            ...
            echo"<tr class=rowheader><td colspan=3 align=center>
