...
while($rCurah=mysql_fetch_assoc($qCurah))
{
    ...
    $dtHarPagi[$tgl]=$rCurah['pagi'];
    $dtHarSore[$tgl]=$rCurah['sore'];
...
{   
    ...
    { 
        ...
        $sDtMm="select distinct sum(pagi+sore) as mm, substr(tanggal,6,2) as bulan from ".$dbname.".kebun_curahhujan 
...
//        $sDtCurah="select distinct sum(pagi+sore) as hh, substr(tanggal,6,2) as bulan  from ".$dbname.".kebun_curahhujan 
//                   where substr(tanggal,1,7) between '".$dtThn5."-01' and '".$dtThn5."-".$kebrp2."' group by tanggal order by tanggal desc";
//        
...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=8 align=left><b>05.3  CURAH  HUJAN </b></td><td colspan=8 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
	...
	<tr>
        <td ".$bgcoloraja." colspan=4>RATA-RATA  CURAH  HUJAN  ( MM )</td></tr>";
        $tab.="<tr><td ".$bgcoloraja." rowspan=2>TGL</td><td ".$bgcoloraja.">Pagi</td>";
        $tab.="<td ".$bgcoloraja.">Siang</td>";
	...
	<tbody>";
        for($tglMula=1;$tglMula<=$jmlHari;$tglMula++)
        {
            ...
            $tab.="<td align=right >".$dtHarPagi[$lstTgl]."</td>";
            $tab.="<td align=right>".$dtHarSore[$lstTgl]."</td>";
            $tab.="<td align=right>".$jmlh[$lstTgl]."</td>";
            $tab.="</tr>";
            ...
            $tab.="</tr>";
            $tab.="<tr class=rowcontent>";
            $tab.="<td>Jumlah Hari Hujan</td>"; 
            $tab.="<td align=right colspan=2>&nbsp;</td>";
            $tab.="<td align=right>".number_format($hariHujan,2)."</td>";
            $tab.="</tr>";
        $tab.="</tbody></table>";
	...
	<tr>
        ...
        <td ".$bgcoloraja." colspan=10>RATA-RATA UMUR TANAMAN</td></tr>";
        $tab.="<tr>";
        $dtThn=$thn[0]-4;
	...
	<tbody>";
         ...
         for($dtThn8;$dtThn8<=$thn[0];$dtThn8++)
         {      
           $hhdt[$dtThn8][1]=$dtHh[$dtThn8][1];
           $mmdt[$dtThn8][1]=$dtMm[$dtThn8][1];
           $tab.="<td align=right>".$dtHh[$dtThn8][1]."</td>";
           $tab.="<td align=right>".$dtMm[$dtThn8][1]."</td>";
...
//           $totMm[$dtThn8]+=$dtMm[$dtThn8][12];
         ...
         for($dtThn8;$dtThn8<=$thn[0];$dtThn8++)
         {            
           $tab.="<td align=right>".$totHh[$dtThn8]."</td>";
           $tab.="<td align=right>".$totMm[$dtThn8]."</td>";
         }
         $tab.="</tr>";
          $tab.="<tr class=rowcontent>";
         $tab.="<td >".$_SESSION['lang']['total']." s.d</td>";
         $dtThn8=$thn[0]-4;
         for($dtThn8;$dtThn8<=$thn[0];$dtThn8++)
         {            
           $tab.="<td align=right>".$totHhsd[$dtThn8]."</td>";
           $tab.="<td align=right>".$totMmsd[$dtThn8]."</td>";
         }
         $tab.="</tr>";
         $tab.="<tr class=rowcontent>";
         $tab.="<td >Rata-rata</td>";
...
//        $tab.="<table cellspacing=0 cellpadding=0>
//  <tr>
//    <td colspan=2>Jumlah  Curah  Hujan  </td>
//    <td>(mm) :</td>
//    <td>  ".number_format($rataSemua,2)."  </td>
//  </tr>
//  <tr>
//    <td colspan=2>Jumlah  Hari     Hujan </td>
//    <td>(HH)  :</td>
//    <td> ".$hariHujan."</td>
//  </tr>
//</table>";
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $afdId;
                ...
                $this->Cell($width,$height,strtoupper("05.3  CURAH  HUJAN"),0,1,'L');
                ...
                $this->Cell(240,$height,"RATA-RATA  CURAH  HUJAN  ( MM )",TBLR,1,'C',1);
                $this->Cell(60,30,"TGL",TBLR,0,'C',1);
                $this->Cell(60,17,"PAGI",TBLR,0,'C',1);
                $this->Cell(60,17,"SIANG",TBLR,0,'C',1);
           ...
           for($tglMula=1;$tglMula<=$jmlHari;$tglMula++)
          {
            ...
            $pdf->Cell(60,$height,"RATA-RATA",1,0,'L',1);
            ...
            $pdf->Cell(120,$height,"Jumlah Hari Hujan",1,0,'L',1);
