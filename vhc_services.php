...
switch($blokStatus) {
	case "vhc":
	$title = "Perbaikan Kendaraan dan Alat Berat";
	$tipe = 'notransaksi';
...
<script language=javascript1.2>
	...
	post_response_text('vhc_slave_services.php?proses=showHeadList', param, respon);
    }
</script>
<script language=javascript src='js/zMaster.js'></script>
<script language=javascript src='js/zSearch.js'></script>
<script language=javascript1.2 src='js/vhc_services.js'></script>
...
$query = selectQuery($dbname,'vhc_service_vw',$cols,$whereCont,
    "tanggal desc, notransaksi desc",false,10,1);
$data = fetchData($query);
$totalRow = getTotalRow($dbname,'vhc_service_vw',$whereCont);
if(!empty($data)) {
