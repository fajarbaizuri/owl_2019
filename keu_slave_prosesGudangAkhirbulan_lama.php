...
#ambil noakun barang
    ...
    if($akunbarang=='' or $akunspl=='')
     ...
     {
         #ambil akun interco
         $str="select akunhutang from ".$dbname.".keu_5caco where kodeorg='".$pengguna."' and jenis='inter'";
            $res=mysql_query($str);
            $akunspl='';
            while($bar=mysql_fetch_object($res))
            {
        ...
        if($akunspl=='')
          ...
          #ambil akun intraco
         $str="select akunhutang from ".$dbname.".keu_5caco where kodeorg='".$pengguna."' and jenis='intra'";
            $res=mysql_query($str);
            $akunspl='';
            while($bar=mysql_fetch_object($res))
            {
        ...
        if($pengguna==substr($_POST['kodegudang'],0,4)){
                    ...
                    # Prep Header
                        ...
                        $dataRes['detail'][] = array(
                            ...
                            'keterangan'=>'Pemakaian barang barang '.$namabarang.' '.$_POST['jumlah']." ".$_POST['satuan'],
                            'jumlah'=>$_POST['hartot'],
                            'matauang'=>'IDR',
                            'kurs'=>'1',
                            'kodeorg'=>substr($_POST['kodegudang'],0,4),
                        ...
                        $dataRes['detail'][] = array(
                            ...
                            'nourut'=>$noUrut,
                            'noakun'=>$akunbarang,
                            'keterangan'=>'Pemakaian barang '.$namabarang.' '.$_POST['jumlah']." ".$_POST['satuan'],
                            'jumlah'=>-1*$_POST['hartot'],
                            'matauang'=>'IDR',
                            'kurs'=>'1',
                            'kodeorg'=>substr($_POST['kodegudang'],0,4),
                   ...
                   #proses data sisi pengguna====================================================
                    ...
                    $dataRes['header'] = array(
                        ...
                        $dataRes['detail'][] = array(
                            ...
                            'nourut'=>$noUrut,
                            'noakun'=>$akunpekerjaan,
                            'keterangan'=>'Pemakaian barang '.$namabarang.' '.$_POST['jumlah']." ".$_POST['satuan'].' '.substr($_POST['tanggal'],0,7),
                            'jumlah'=>$_POST['hartot'],
                            'matauang'=>'IDR',
                            'kurs'=>'1',
                            'kodeorg'=>$pengguna,
