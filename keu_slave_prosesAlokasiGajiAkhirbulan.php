...
#periksa dan hapus transaksi untuk data yang sudah di proses pada periode yang sama    
    $str="delete from ".$dbname.".keu_jurnalht where kodejurnal in ('KBNB0','KBNB1','KBNB2','KBNB3',
    'KBNB4','KBNB5','VHCG0','VHCG1','VHCG2','VHCG3','VHCG4','VHCG5','WSG0','WSG1','WSG2','WSG3','WSG4',
    'WSG5','KBNL0','KBNL1','KBNL2','KBNL3','PKS01','PKS02','PKS03','PKS04','PKS05') and tanggal='".$tanggal."' 
...
if($tip=='PABRIK' && (($param['tipeorganisasi']=='STATION' and $param['subbagian']!='CBGM00') || ($param['tipeorganisasi']=='GUDANG' and $param['subbagian']!='CBGM60'))){
prosesGajiPabrik(); 
}else if($param['tipeorganisasi']=='WORKSHOP'){
   prosesGajiWs(); 
}else if($param['tipeorganisasi']=='SIPIL'){
   prosesGajiSipil();
}else if(($param['tipeorganisasi']=='AFDELING' and $param['subbagian']!='TDAE00') ||
($param['tipeorganisasi']=='AFDELING' and $param['subbagian']!='TDBE00') ||
($param['tipeorganisasi']=='AFDELING' and $param['subbagian']!='USJE00') ||
($param['tipeorganisasi']=='GUDANG' and $param['subbagian']!='TDAE60') ||
($param['tipeorganisasi']=='GUDANG' and $param['subbagian']!='TDBE60') ||
($param['tipeorganisasi']=='GUDANG' and $param['subbagian']!='USJE60') || 
($param['tipeorganisasi']=='GUDANG' and $param['subbagian']!='TKFB22') || 
$param['tipeorganisasi']=='BIBITAN'){
   prosesGajiAfdeling();
   ...
   prosesGajiWs();  
}else if($tip!='' and $param['subbagian']!=''){                 #Karyawan kantor (BTL) kebun dan pabrik
   prosesGajiKebun();   
}	
        ...
        while($bar=mysql_fetch_object($res))
        {
           ...
           $dataRes['detail']='';
            ...
            if($bar->tipetransaksi=='BBT')
               $group='KBNL0';
            else if($bar->tipetransaksi=='TBM' or $bar->tipetransaksi=='TB' or $bar->tipetransaksi=='LC')
               $group='KBNL1';
