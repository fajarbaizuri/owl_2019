...
if($tab=='cekclose'){
    ...
    $str="select * from ".$dbname.".bgt_budget
        where tutup = 1 and tipebudget = '".$tipebudget."' and kodebudget != 'UMUM' and tahunbudget ='".$tahunbudget."' limit 0, 1";
    $res=mysql_query($str);
    $hkef='';
    while($bar= mysql_fetch_object($res))
    {
...
if($tab=='1'){
    ...
    $str="select * from ".$dbname.".bgt_budget
        where tipebudget = '".$tipebudget."' and kodebudget like 'M%' and tahunbudget ='".$tahunbudget."' and kodeorg ='".$mesin."' and kodebarang ='".$kodebarang1."'";
    $res=mysql_query($str);
    //$no=1;
    $hkef='';
    while($bar= mysql_fetch_object($res))
   ...
   if($akun==''){
    ...
    VALUES (
    '".$tipebudget."', '".$tahunbudget."', '".$mesin."', '".$kodebudget1."','".$akun."','".$regional1."', '".$kodebarang1."', '".$jumlah1."', '".$satuan1."', '".$totalharga1."', '".$jenis1."', '".$_SESSION['standard']['userid']."',
    CURRENT_TIMESTAMP 
    )";
...
if($tab=='5'){
	...
	$qIns = insertQuery($dbname,'bgt_budget',$data,$cols);
	if(!mysql_query($qIns)){
