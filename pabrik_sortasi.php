...
OPEN_BOX('',"<b>".$_SESSION['lang']['pabrikSortasi']."</b>");
?>
...
<!--<table cellspacing="1" border="0">
<tr>
<td><?php echo $_SESSION['lang']['noTiket']?></td>
<td>:</td>
<td>
<select id="noTiket" name="noTiket" style="width:150px" onchange="getForm()"></select></td>
</tr>


<tr>
<td colspan="3" id="tmbLheader">
<button class="mybutton" id="cancelAbn" onclick="cancelForm()" ><?php echo $_SESSION['lang']['cancel']?></button>
</td>
</table>-->
</div>
