...
<legend><b>Slip Gaji Harian</b></legend>
...
<div>
<fieldset style="float: left;">
<legend><b>Slip Gaji Harian Per Karyawan</b><?php //echo $_SESSION['lang']['']?></legend>
<table cellspacing="1" border="0" >
...
<tr height="20"><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2" align="center"><button onclick="zPreview('sdm_slave_2slipGajiHarian','<?php echo $arrKry?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><button onclick="zPdf('sdm_slave_2slipGajiHarian','<?php echo $arrKry?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button></td></tr>
</table>
</fieldset>
</div>
<div style="margin-bottom: 30px;">
<fieldset style="float: left;">
<legend><b>Slip Gaji Harian Per Afdeling</b><?php //echo $_SESSION['lang']['']?></legend>
<table cellspacing="1" border="0" >
