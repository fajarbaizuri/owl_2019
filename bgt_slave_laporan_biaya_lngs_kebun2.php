...
//jumlah unplantend
 $str="select sum(hathnini) as luas,thntnm from ".$dbname.".bgt_blok where 
      kodeblok like '".$kodeOrg."%' and statusblok ='CADANGAN' and tahunbudget='".$thnBudget."' 
      group by thntnm";
$res=mysql_query($str);
while($bar=mysql_fetch_object($res))
{
...
//get tahun tanam
$sThnTnm="select distinct thntnm from ".$dbname.".bgt_budget_kebun_perblok_vw where  kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."' order by noakun asc";
...
//get no akun
$sNoakun2="select distinct noakun from ".$dbname.".bgt_budget where kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."' and tipebudget='ESTATE' and kodebudget!='UMUM' group by  noakun order by noakun asc";
//exit("error".$sNoakun2);
...
$sNoakunRupiah2="select distinct substr(noakun,1,5) as aknKpala,sum(rupiah) as  rupiah,tahunbudget from ".$dbname.".bgt_budget where  kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."' and tipebudget='ESTATE' and kodebudget!='UMUM'  group by aknKpala";
...
$sAkunRupiah="select distinct substr(noakun,1,5) as aknKpala,sum(rupiah) as  rupiah,tahunbudget,thntnm from ".$dbname.".bgt_budget_kebun_perblok_vw where kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."'  group by thntnm,aknKpala";
...
//noakun
$sNoakun="select noakun,thntnm,tahunbudget,sum(rupiah) as rupiah from ".$dbname.".bgt_budget_kebun_perblok_vw where kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."' group by thntnm,noakun order by noakun asc";
...
$sTotAkun="select sum(rupiah) as total,noakun from ".$dbname.".bgt_budget_kebun_perblok_vw where  kodeorg like '".$kodeOrg."%' and tahunbudget='".$thnBudget."'  group by noakun";
...
//                                    }    
                                    ...
                                    if(substr($barisNoakun,0,5)>='12201' and substr($barisNoakun,0,5)<='12204')
                                    {
                                    ...
                                    else if(substr($barisNoakun,0,5)>'12204')
                                    {
                                        if(substr($barisNoakun,0,3)<'127')
                                        {
                                       @$hslBagi[$thnBudget][$lstThaTnm][$ktKrgng]=$dtNoakunRup[$thnBudget][$lstThaTnm][$ktKrgng]/$dtJmlhLuastbm[$thnBudget][$lstThaTnm];
                                        ...
                                        else if(substr($barisNoakun,0,3)=='127')
                                        {
             ...
             foreach($dtNoakun as $barisNoakun)
                 ...
                 $drAwal+=1;
                      ...
                      if($brs==1) 
                      {
                            ...
                            if(substr($barisNoakun,0,3)<'127')//TBM
                            {
                            ...
                            else if(substr($barisNoakun,0,3)=='127')//BBT
                            {
