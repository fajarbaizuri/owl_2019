...
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '7110101%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71101[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71102-Biaya non staf
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '7110102%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71102[$res['noakun']]=$res['noakun'];
}  

// kamus akun 7120 Operasional Karyawan
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun between '7110103' and '7110110'  ORDER BY noakun";
//exit("Error".$aresta);
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list7120[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71301 Operasional Mess dan Kantor
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71102%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71301[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71302 Biaya Kantor Unit
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71103%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71302[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71303 Biaya Kebersihan
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71104%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71303[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71304 Biaya Telekomunikasi
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71105%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71304[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71305 Biaya Telekomunikasi
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71106%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71305[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71306 Pajak dan Retribusi
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71107%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71306[$res['noakun']]=$res['noakun'];
}  
...
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71307[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71308 Biaya Keamanan dan Sosial Lainnya
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71108%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71308[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71308 Biaya Keamanan dan Sosial Lainnya
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71110%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71308[$res['noakun']]=$res['noakun'];
...
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71111%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71409[$res['noakun']]=$res['noakun'];
}  
/*
// kamus akun 71501 Pembelian Barang Inventaris (non Asset)
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71501%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71501[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71502 Penyusutan Tanaman Menghasilkan/Amortisasi
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71502%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71502[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71503 Amortisasi
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71503%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71503[$res['noakun']]=$res['noakun'];
}  

// kamus akun 71899 Biaya Bank Unit
$aresta="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun WHERE length(noakun)=7 and noakun like '71899%' ORDER BY noakun";
$query=mysql_query($aresta) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
    $dzArr[$res['noakun']]['noakun']=$res['noakun']; $dzArr[$res['noakun']]['namaakun']=$res['namaakun']; $list71899[$res['noakun']]=$res['noakun'];
}  
*/
...
$str="SELECT noakun, sum(jumlah) as jumlah FROM ".$dbname.".keu_jurnaldt 
    WHERE tanggal like '".$periode."%' and nojurnal like '%".$unit."%' group by noakun
    ";
//exit("Error".$str);
$query=mysql_query($str) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
...
$str="SELECT noakun, sum(jumlah) as jumlah FROM ".$dbname.".keu_jurnaldt 
    WHERE (tanggal between '".$tahun."-01-01' and LAST_DAY('".$periode."-15')) and nojurnal like '%".$unit."%' group by noakun
    ";
$query=mysql_query($str) or die(mysql_error($conn));
while($res=mysql_fetch_assoc($query))
{
...
$tab.="<table border=0>
     <tr>
        <td colspan=8 align=left><font size=3>24. BIAYA TIDAK LANGSUNG</font></td>
...
if($proses!='excel')$tab.=$judul;
    ...
    <tr>
    <td align=right colspan=2 ".$bg.">Luas:</td>
...
// excel array content =========================================================================
    if(empty($dzArr)){
        ...
        $tab.= "<td colspan=2>Biaya Karyawan</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>7110101-Biaya Staf</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>7110102-Biaya non staf</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>7110103 Biaya Karyawan Lainnya</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>Total Biaya Karyawan</td>";
        ...
        $no=1;
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>Biaya Komunikasi</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71102 Biaya Komunikasi</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71103 Perjalanan Dinas</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71104 Alat Tulis Kantor</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71105 Biaya Keamanan</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71106 Biaya Sosial</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71107 Biaya Kendaraan</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71108 Pemeliharaan Prasarana</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
        ...
        $tab.= "<tr class=rowcontent>";
        $tab.= "<td colspan=2>71110 Biaya Overhead Lainnya</td>";
        $tab.= "<td colspan=12></td>";
        $tab.= "</tr>";
