 ...
 class PDF extends FPDF
        {
            function Header() {
                ...
                $this->Cell($width,$height,$_SESSION['lang']['relasi'],0,1,'C');	
                $this->Ln();	
				...
				$this->Cell(15/100*$width,$height,$_SESSION['lang']['nama'],1,1,'C',1);						
            }
		...
		while($res=mysql_fetch_assoc($re))
		{
			...
			$pdf->Cell(15/100*$width,$height,$res['nosertifikat'],1,0,'C',1);	
			$pdf->Cell(15/100*$width,$height,$rPem['nama'],1,1,'C',1);						
		}
