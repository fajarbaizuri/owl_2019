...
$optBarang=makeOption('owl','log_5masterbarang','kodebarang,namabarang',$where,2);
$sbrg="select * from owl.log_5masterbarang where kodebarang='".$row['kodebarang']."'";
$qbrg=mysql_query($sbrg) or die(mysql_error());
$res=mysql_fetch_assoc($qbrg);
$where2=" kodebarang='".$row['kodebarang']."' and darisatuan='".$res['satuan']."'";
$optSatuan=makeOption('owl','log_5stkonversi','satuankonversi',$where2,1);
