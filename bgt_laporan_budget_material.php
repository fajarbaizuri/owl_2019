...
$sSup="select distinct substr(kodebudget,3,3) as kelompokbarang from ".$dbname.".bgt_budget_detail where kodebudget like 'M%' or kodebudget like 'S-%' order by substr(kodebudget,3,3) asc";
//echo $sSup;
...
<tr><td><label><?php echo $_SESSION['lang']['pilih']?></label></td><td><select id="pilMode" name="pilMode" style="width:150px"><? echo $optPilMode?></select></td></tr>
