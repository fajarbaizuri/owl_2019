...
<td>:</td>
<td><input type="text" class="myinputtextnumber" id="dwnTime" name="dwnTime" onkeypress="return angka_doang(event);"  value="0"  maxlength="10" style="width:150px;" />&nbsp;<?php echo $_SESSION['lang']['jam']?></td>
</tr>
<tr>
