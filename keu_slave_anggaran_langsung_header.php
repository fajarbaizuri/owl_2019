...
switch($proses) {
    ...
    case 'addHeader':
        # Prepare Options
        $optOrg = getOrgBelow($dbname,$_SESSION['empl']['lokasitugas'],false);
    ...
    case 'showList':
        # Extract Data
        $lokTugas = getOrgBelow($dbname,$_SESSION['empl']['lokasitugas'],true,'noblok');
	$whereLok = "";
	$i=0;
    ...
    case 'editHeader':
        # Get Data
        $where = "kodeanggaran='".$_POST['kodeanggaran']."' and tahun=".$_POST['tahun'].
	    " and kodeorg='".$_POST['kodeorg']."' and revisi=".$_POST['revisi'];
    ...
    case 'edit':
        ...
        $where = "kodeanggaran='".$data['kodeanggaran']."' AND ".
            ...
            "tahun='".$data['tahun']."' AND revisi=".$data['revisi'];
