...
$str="select periode, tanggalmulai, tanggalsampai from ".$dbname.".setup_periodeakuntansi where kodeorg='".$_SESSION['empl']['lokasitugas']."' and tutupbuku = '0' order by periode desc";
...
$where = "tanggal >= '".$periodemulai."' and tanggal <= '".$periodesampai."' and unit='".$_SESSION['empl']['lokasitugas']."'";
$cols = 'noinvoice,kodeorg,tanggal,updateby,nopo,keterangan,nilaiinvoice,unit';
$colArr = explode(',',$cols);
...
$length = explode(",","15,10,8,14,18,18,12,8");
