...
if($periode=='')
	$str="select a.tanggal as tanggal, a.nopo,a.kodebarang as kodebarang, a.satuan as satuan, a.jumlah as jumlah, a.idsupplier as idsupplier, b.namasupplier as namasupplier, a.hargasatuan as hargasatuan 
...
//		$this->Cell(20,5,$namagudang,'',1,'L');
		...
		$this->Cell(15,5,$_SESSION['lang']['nopo'],1,0,'C');
