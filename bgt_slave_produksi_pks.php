...
$arrBln=array("1"=>"Kg.Tbs.Jan","2"=>"Kg.Tbs.Feb","3"=>"Kg.Tbs.Mar","4"=>"Kg.Tbs.Apr","5"=>"Kg.Tbs.Mei","6"=>"Kg.Tbs.Jun","7"=>"Kg.Tbs.Jul","8"=>"Kg.Tbs.Aug","9"=>"Kg.Tbs.Sep","10"=>"Kg.Tbs.Okt","11"=>"Kg.Tbs.Nov","12"=>"Kg.Tbs.Des");
//$optNmOrg=makeOption($dbname, 'organisasi', 'kodeorganisasi,namaorganisasi');
?>
...
{	
        ...
        if($totalSum>$kgtbs)
        {
            exit("Error:Total Berat Perbulan ".$totalSum." Lebih Besar Dari Total Setahun :".$kgtbs."");
    ...
    break;
        ...
        if($totalSum>$kgtbs)
        {
            exit("Error:Total Berat Perbulan Lebih Besar Dari Total Setahun");
                }
                $sUpdate="update ".$dbname.".bgt_produksi_pks set updateby='".$_SESSION['standard']['userid']."'";
                // exit("Error".$sUpdate);
                for($a=1;$a<=$totRow;$a++)
                {
                        if(strlen($a)=='1')
        ...
        case 'cekclose':
            //echo"warning:masuk";
                ...
                //exit("error:$aCek");
                        if($cCek['tutup']==1)
                        {
                                echo "warning : Input untuk tahun ".$thnbudget." dengan kode ".$kdpks." tidak bisa dilakukan karena telah di tutup";
                                exit();	
                        }      
                        else
                        {
