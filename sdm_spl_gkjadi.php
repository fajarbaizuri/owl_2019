...
<tbody>
	<tr class=rowcontent>
		<td><select id=ki style=\"width:200px;\" onchange='getUangLembur()'>".$optkar."</select></td>
		<td><select id=tpl style=\"width:200px;\" onchange='getUangLembur()'>".$optTipelembur."</select></td>
		<td><input type=text id=ul size=10 disabled onkeypress=\"return angka_doang(event);\" class=myinputtext maxlength=6 style=\"width:75px;\"></td>
		<td><input type=text id=um size=10 onkeypress=\"return angka_doang(event);\" class=myinputtext maxlength=6 style=\"width:75px;\"></td>
		<td><input type=text id=ut size=10 onkeypress=\"return angka_doang(event);\" class=myinputtext maxlength=6 style=\"width:75px;\"></td>
