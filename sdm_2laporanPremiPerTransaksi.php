...
<legend><b><?php echo $_SESSION['lang']['laporanPremi'];?>/Kemandoran</b></legend>
...
<tr><td colspan="2">
	...
	<button onclick="zPdf('sdm_slave_2laporanPremiPerKemandoran','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button>
