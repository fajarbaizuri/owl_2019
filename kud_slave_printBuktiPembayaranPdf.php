...
//=============
 ...
 class PDF extends FPDF
		...
		$str="select jumlah,nosertifikat,tanggalbayar,namapenerima,dibayaroleh,mengetahui from ".$dbname.".".$_GET['table']."  where idpemilik='".$idPemilik."' and statuspembayaran='1'"; 
		//echo $str;exit();
