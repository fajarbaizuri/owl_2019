...
$param = $_POST;
$tanggal=(string)$param['periode']."-28";
...
#============================================================================
  prosesAlokasi($tanggal,$param);  
  
}
    
function prosesByBengkel($tanggal,$param){
    global $conn;
    //global $tanggal;
    //global $param;
    global $dbname;
...
function prosesAlokasi($tanggal,$param){
    global $conn;
    //global $tanggal;
    //global $param;
    global $dbname; 
        ...
        if($intern)
         {  
           ...
           # Data Detail
            ...
            # Transform No Jurnal dari No Transaksi
            $nojurnal = str_replace("-","",$tanggal)."/".$pengguna."/".$kodeJurnal."/".$konter;
            #======================== /Nomor Jurnal ============================
            # Prep Header
