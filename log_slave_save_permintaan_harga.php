...
//					}
				...
				if($txt_search!='')
			{
				$where=" nomor LIKE  '%".$txt_search."%' or nopp LIKE  '%".$txt_search."%'";
			}
			elseif($txt_tgl!='')
			{
			...
			{
				$where.=" nomor LIKE '%".$txt_search."%' or nopp LIKE  '%".$txt_search."%' or tanggal LIKE '%".$txt_tgl."%'";
			}
		//echo $strx; exit();
			...
			$query2=mysql_query($sql2) or die(mysql_error());
				...
				break;
								...
								$a1="select nopp from ".$dbname.".log_perintaanhargaht where nomor='".$nomor."'";
...
*/                                $sAlmat="select namaorganisasi,alamat,telepon from ".$dbname.".organisasi where kodeorganisasi='".$_SESSION['org']['kodeorganisasi']."'";
                                ...
                                $stream="<table cellspacing=1 cellpadding=1 style=\"border-bottom:solid 1px;\">
                                    ...
                                    <font size=5><b>".strtoupper($nmorg)."</b></font><br />
                                    <font size=3>".$alamatorg."</font><br />    
                                    <font size=3>Telp : ".$telporg."</font><br />  
