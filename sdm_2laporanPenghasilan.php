...
<legend><b>Penghasilan/Hari</b></legend>
...
<tr><td colspan="2">
	<button onclick="zPreview('sdm_slave_2laporanPendapatan','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	
	<button onclick="zExcel(event,'sdm_slave_2laporanPendapatan.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
