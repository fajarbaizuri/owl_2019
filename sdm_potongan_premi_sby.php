...
OPEN_BOX('',$_SESSION['lang']['premisudahbayar']);

$optPeriode='<option value=""></option>';
$sGp="select DISTINCT periode from ".$dbname.".sdm_5periodegaji where kodeorg='".$_SESSION['empl']['lokasitugas']."' and `sudahproses`=0 order by periode desc limit 6";
...
$strKom="select * from ".$dbname.".sdm_ho_component where id in('36','37','38','42')";	  
}else{
$strKom="select * from ".$dbname.".sdm_ho_component where id in('36','37','42')";	  
}
...
echo "<div>";
	...
	where a.idkomponen in ('36','37') and  b.lokasitugas = '".$_SESSION['empl']['lokasitugas']."'
