...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=5 align=left><b>25.2 KENDARAAN</b></td><td colspan=7 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
	...
	<thead class=rowheader>";
        $tab.="<tr>";
        $tab.="<td rowspan=2>Jenis</td>";
        $tab.="<td rowspan=2>Nama Kendaraan/Mesin</td>";
        $tab.="<td rowspan=2>Thn Perolehan</td>";
        $tab.="<td rowspan=2>Kepemilikan</td>";
        $tab.="<td rowspan=2>Unit Pemilik</td>";
        $tab.="<td rowspan=2>KODE KEND</td>";
        $tab.="<td colspan=2>NOMOR</td>";
        $tab.="<td rowspan=2>PENANGGUNG JAWAB PEMAKAI</td></tr>";
        $tab.="<tr><td>RANGKA</td>";
        $tab.="<td>MESIN</td>";
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $tot;
                ...
                $this->Cell($width,$height,strtoupper("25.2 KENDARAAN"),0,1,'L');
                ...
                $this->Cell(30,$height,"JENIS",TLR,0,'C',1);
                $this->Cell(120,$height,"Nama Kendaraan/Mesin",TLR,0,'C',1);
                $this->Cell(45,$height,"Thn",TLR,0,'C',1);
                $this->Cell(75,$height,"Kepemilikan",TLR,0,'C',1);
                $this->Cell(55,$height,"Unit Pemilik",TLR,0,'C',1);
                $this->Cell(75,$height,"KODE",TLR,0,'C',1);
                $this->Cell(200,$height,"NOMOR",TLR,0,'C',1);
                $this->Cell(100,$height,"PENANGGUNG JAWAB",TLR,1,'C',1);
                
                
               $this->Cell(30,$height," ",BLR,0,'C',1);
                $this->Cell(120,$height," ",BLR,0,'C',1);
                $this->Cell(45,$height,"Perolehan",BLR,0,'C',1);
                $this->Cell(75,$height," ",BLR,0,'C',1);
                $this->Cell(55,$height," ",BLR,0,'C',1);
                $this->Cell(75,$height,"KEND",BLR,0,'C',1);
                $this->Cell(100,$height,"RANGKA",TBLR,0,'C',1);
                $this->Cell(100,$height,"MESIN",TBLR,0,'C',1);
                $this->Cell(100,$height,"PEMAKAI",BLR,1,'C',1);
