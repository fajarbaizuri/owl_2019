...
$frm[1].="<table cellspacing=1 border=0>
		...
		<tr><td>".$_SESSION['lang']['volume']."</td><td><input type=text class=myinputtextnumber id=jmlh name=jmlh maxlength=7 value='0' onkeypress=\"return angka_doang(event);\" style='width:150px'/> KG</td></tr>
