...
<tr><td><label><?php echo $_SESSION['lang']['afdeling']?></label></td><td><select id="kdAfd" name="kdAfd" style="width:150px" onchange="geKeg()"><option value=""></option></select></td></tr>
...
<tr><td><label><?php echo "Kegiatan"?></label></td><td><select id="kdKeg" name="kdKeg" style="width:150px"><option value=""></option></select></td></tr>
