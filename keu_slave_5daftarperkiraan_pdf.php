...
#        }
        ...
        $this->Cell(55,1.5*$height,$_SESSION['lang']['matauang'],'TBLR',0,'C');
        $this->Cell(45,1.5*$height,$_SESSION['lang']['tampilkan'],'TBLR',0,'C');        
        $this->Cell(35,1.5*$height,$_SESSION['lang']['detail'],'TBLR',0,'C');
        $this->Ln();
        $this->Ln();
    }
}
...
foreach($result as $data) {
	...
	$pdf->Cell(60,$height,$data['matauang'],'',0,'C');
        $pdf->Cell(45,$height,$data['pemilik'],'',0,'C');        
	if ($data['detail']==1)
	{
	$pdf->Cell(35,$height,'Y','',0,'C');
	}
    $pdf->Ln();
}
