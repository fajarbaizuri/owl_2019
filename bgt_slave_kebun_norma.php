...
switch($proses)
{
    ...
    case'saveSdm':
		...
		if($rCek<1)
		{
            $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv, rupiah,rotasi,updateby,jumlah,satuanj) values
                ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdGol."','".$kegId."','".$noAkun."','".$volKeg."','".$satuan."','".$totBiaya."','".$rotThn."','".$_SESSION['standard']['userid']."','".$jmlhPerson."','HK')";
			if(mysql_query($sIns))
			echo"";
			else
			echo "DB Error : ".$sIns."\n".mysql_error($conn);
    ...
    case'saveMat':
          ...
          if($rCek<1)
          {
              ...
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodebarang, regional, updateby,jumlah,satuanj) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudget."','".$kegId."','".$noAkun."','".$volKeg."','".$satuan."','".$totHarga."','".$rotThn."','".$kdBrg."','".$rRegion['regional']."','".$_SESSION['standard']['userid']."','".$jmlhBrg."','".$satuanBrg."')";
              if(mysql_query($sIns))
              echo"";
              else
             echo "DB Error : ".$sIns."\n".mysql_error($conn);
    ...
    case'saveKontrak':
		if($kdBudgetK==''||$totBiayaK==0||$volKontrak=='')
		{
          ...
          if($rCek<1)
          {
              ...
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi,  updateby,jumlah,satuanj) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetK."','".$kegId."','".$noAkun."','".$volKeg."','".$satuan."','".$totBiayaK."','".$rotThn."','".$_SESSION['standard']['userid']."','".$volKontrak."','".$satKontrak."')";
              if(mysql_query($sIns))
              echo"";
              else
             echo "DB Error : ".$sIns."\n".mysql_error($conn);
    ...
    case'saveTool':
		if($kdBudgetL==''||$totHargaL==0||$jmlhBrgL==''||$kdBrgL=='')
		{
          ...
          {
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodebarang, regional, updateby,jumlah,satuanj) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetL."','".$kegId."','".$noAkun."','".$volKeg."','".$satuan."','".$totHargaL."','".$rotThn."','".$kdBrgL."','".$rRegion['regional']."','".$_SESSION['standard']['userid']."','".$jmlhBrgL."','".$satuanBrgL."')";              
		...
		if($kdBudgetV==''||$totBiayaKend==0||$jmlhJam=='')
		{
          ...
          if($rCek<1)
          {
              ...
              $sIns="insert into ".$dbname.".bgt_budget (tahunbudget,kodeorg, tipebudget, kodebudget, kegiatan, noakun, volume, satuanv,rupiah,rotasi, kodevhc, updateby,jumlah,satuanj) values
                  ('".$thnBudget."','".$kdBlok."','".$tpBudget."','".$kdBudgetV."','".$kegId."','".$noAkun."','".$volKeg."','".$satuan."','".$totBiayaKend."','".$rotThn."','".$kdVhc."','".$_SESSION['standard']['userid']."','".$jmlhJam."','".$satVhc."')";
              if(mysql_query($sIns))
               echo"";
              else
             echo "DB Error : ".$sIns."\n".mysql_error($conn);
            ...
            case'getDetailData':
               ...
               // exit("error".$sData);
                ...
                while($rData=mysql_fetch_assoc($qData))
                {
                    ...
                    if($rData['tutup']==0)
                    {
                    $tab.="<td  align=center style='cursor:pointer;'><img id='detail_edit' title='Edit' class=zImgBtn onclick=\"filFieldHead('".$rData['tahunbudget']."','".$rData['kodeorg']."','".$rData['tipebudget']."','".$rData['noakun']."','".$rData['kegiatan']."','".$rData['volume']."','".$rData['satuanv']."','".$rData['rotasi']."')\" src='images/application/application_edit.png'/></td>";
