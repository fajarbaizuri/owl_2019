...
$tanggal=$periode."-28";
     ...
     {
        exit("Error: Periode sudah tutup buku (Closed)");
     }   
...
case 'post':
        ...
        {
            exit("Error: Periode penggajian belum ada pada periode tersebut");
        }   
        ...
        {
            if($akunpanen=='')
                exit('Error: PNN01 Belum terdaftar di parameter jurnal');
            else{
        ...
        while($baru=mysql_fetch_object($resu))
        {
            #cari akun debet pengawasan
                ...
                if($akund==''){
                    exit('Error: kodejurnal '.$group.' belum tersedia pada parameterjurnal');
                }
