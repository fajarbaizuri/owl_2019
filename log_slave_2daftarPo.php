...
//			}
		//echo $strx; exit();
				...
				$strx="SELECT * FROM ".$dbname.".log_poht where statuspo>1 ".$where." order by tanggal desc limit ".$offset.",".$limit."";
...
//						  {
		...
		$limit=20;
			...
			$sql2="select count(*) as jmlhrow from ".$dbname.".log_poht where stat_release=1   ORDER BY nopo DESC";
			$query2=mysql_query($sql2) or die(mysql_error());
			while($jsl=mysql_fetch_object($query2)){
			$jlhbrs= $jsl->jmlhrow;
			}
	 // stat_release='1'
		$str="SELECT * FROM ".$dbname.".log_poht where stat_release=1   ORDER BY tanggal DESC limit ".$offset.",".$limit."";
			//echo $str;
