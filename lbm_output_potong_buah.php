...
<tr><td colspan=\"2\">
<button onclick=\"zPreview('lbm_slave_output_potong_buah','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button>
<button onclick=\"zPdf('lbm_slave_output_potong_buah','".$arr."','reportcontainer')\" class=\"mybutton\">PDF</button>    
<button onclick=\"zExcel(event,'lbm_slave_output_potong_buah.php','".$arr."')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Excel</button></td></tr>
