...
echo"<table>
     <thead>
        ...
        <tr>
            <td valign='top'>";
            OPEN_BOX('','LBM-MONITORING');
            echo"<fieldset><legend>".$_SESSION['lang']['navigasi']."</legend>
                 <div id='navcontainer' style='width:250px;height:500px;overflow:scroll;background-color:#FFFFFF;'>";
                 $x=readCountry('config/lbm_monitoring.lst');
        ...
        echo"</td><td>";
            ...
            echo"<fieldset><legend>".$_SESSION['lang']['form']."</legend>
                 <div id='formcontainer' style='width:900px;height:180px;overflow:scroll'></div> 
                 </fieldset>";            
            CLOSE_BOX();  
            OPEN_BOX('','');
