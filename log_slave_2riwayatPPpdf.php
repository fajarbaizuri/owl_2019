        ...
        class PDF extends FPDF
        {
            function Header() {
               ...
               // $this->Cell((20/100*$width)-5,$height,$_SESSION['lang']['kodeorg'],'',0,'L');
                ...
                //$this->Cell(45/100*$width,$height,$kdorg[4],'',0,'L');
                //$this->Cell((20/100*$width)-5,$height,$_SESSION['lang']['user'],'',0,'L');
                //$this->Cell(5,$height,':','',0,'L');
                //$this->Cell(15/100*$width,$height,$_SESSION['standard']['username'],0,0,'L');
				$this->Cell((5/100*$width)-5,$height,$_SESSION['lang']['user'],'',0,'L');
				$this->Cell(5,$height,':','',0,'L');
				$this->Cell(60/100*$width,$height,$_SESSION['standard']['username'],'',0,'L');

                $this->Ln();
				//$query2 = selectQuery($dbname,'organisasi','namaorganisasi',
//				"kodeorganisasi='".$kdOrg."'");
//				$orgData2 = fetchData($query2);
//                $this->Cell((20/100*$width)-5,$height,$_SESSION['lang']['nopp'],'',0,'L');
//                $this->Cell(5,$height,':','',0,'L');
//                $this->Cell(45/100*$width,$height,$nopp,'',0,'L');
...
//               	$this->Cell(15/100*$width,$height,date('d-m-Y H:i:s'),'',1,'L');		
               /* $this->Cell((20/100*$width)-5,$height,$_SESSION['lang']['periode'],'',0,'L');
				...
				$this->Cell((5/100*$width)-5,$height,$_SESSION['lang']['tanggal'],'',0,'L');
				$this->Cell(5,$height,':','',0,'L');
				$this->Cell(60/100*$width,$height,date('d-m-Y H:i:s'),'',0,'L');
				$this->Ln();	$this->Ln();
				$this->Ln();
