 ...
 while($bar=mysql_fetch_object($res))
  {
     ...
     $stream.="<tr class=rowcontent>
                ...
                <td><input type=text id=natura".$no." style='background-color:".$style."'  value='".$natura[$bar->karyawanid]."' class=myinputtextnumber   size=10 maxlength=8 onkeypress=\"return angka_doang(event);\" onchange=\"this.style.backgroundColor='orange';\"></td>
