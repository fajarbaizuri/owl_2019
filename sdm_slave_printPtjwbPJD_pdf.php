...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->SetY(22);   
	    $this->Cell(60,5,'PT.PERKEBUNAN MINANGA OGAN',0,1,'C');	 
...
/* jika sudah ada pertanggungjawaban berarti ini diabaikan
	$pdf->Ln();	
	$pdf->SetX(20);	
	$pdf->SetFont('Arial','B',10);
	...
	$pdf->SetX(30);
		...
		$pdf->Cell(27,5,strtoupper($_SESSION['lang']['keputusan']),1,1,'C');	 			
...
//footer================================
	...
	$pdf->Cell(95,5,'Menyetujui,',0,1,'C');
    $pdf->Ln();
    $pdf->Ln();
    $pdf->Ln();
	$pdf->Cell(95,5,'-------------------------',0,0,'C');
