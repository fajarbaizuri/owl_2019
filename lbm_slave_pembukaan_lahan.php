...
// cari kegiatan
$kegiatan="SELECT kodekegiatan, namakegiatan, satuan FROM ".$dbname.".setup_kegiatan WHERE `kelompok` = 'TB' order by kodekegiatan";
...
$tab.="<table border=0>
     <tr>
        <td colspan=15 align=left><font size=3>14. PEMBUKAAN LAHAN</font></td>
...
switch($proses)
{
    ...
    function Header() {
        ...
        $this->Cell($width/2,$height,'14. PEMBUKAAN LAHAN',NULL,0,'L',1);
