...
#1. Ambil gaji total per karyawan yang plus pada unit bersangkutan
 ...
 if(empty($masukkotak))
     exit('Info: gaji karyawan langsung sudah teralokasi dengan benar');
             ...
             echo"Gaji Karyawan langsung yang belum teralokasi(Hr.Minggu/Libur):
                  <button class=mybutton onclick=prosesGajiLangsung(1) id=btnproses>Process</button>
                  ...
                  <thead>
                    ...
                    <td>Subbagian</td>
                    <td>Tipe</td>
                    <td>Belum Dialokasi</td>
                    <td>Gaji Kotor</td>
                    <td>Sudah Dialokasi</td>
                    </tr>
                  </thead>
                  <tbody>";
             $no=0;
