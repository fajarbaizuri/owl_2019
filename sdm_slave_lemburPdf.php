...
//			$this->Cell(2,5,':','',0,'L');
//			$this->Cell(35,5,$rIsi['periode'],0,1,'L');
			//		$this->Cell(140,5,' ','',0,'R');	
			//			$this->Cell(140,5,' ','',0,'R');
...
//			$this->Cell(80,5,$_SESSION['standard']['username'],'',1,'L');
	...
	$pdf->SetY(55);
	$pdf->Cell(190,5,$_SESSION['lang']['list']." ".$_SESSION['lang']['lembur'],0,1,'C');	
	$pdf->Ln();	
	$pdf->SetFont('Arial','B',9);	
	$pdf->SetFillColor(220,220,220);
    $pdf->Cell(8,5,'No',1,0,'L',1);
	$pdf->Cell(30,5,$_SESSION['lang']['namakaryawan'],1,0,'C',1);	
	$pdf->Cell(25,5,$_SESSION['lang']['tipelembur'],1,0,'C',1);
	...
	$pdf->SetFont('Arial','',9);
		...
		while($res=mysql_fetch_assoc($re))
		{
			...
			$no+=1;
			$pdf->Cell(8,5,$no,1,0,'L',1);
			$pdf->Cell(30,5,$rKry['namakaryawan'],1,0,'C',1);	
			$pdf->Cell(25,5,$arrTipeLembur[$res['tipelembur']],1,0,'C',1);
