...
<?php
OPEN_BOX('',$_SESSION['lang']['pabrikTimbangan']);
...
<fieldset>
	  ...
	  <fieldset>
		...
		<table cellspacing=1 border=0>
			...
			<tr>
			<td>nb. Untuk satuan berat menggunakan kg secara default</td></tr>
		</table>
	  </fieldset>
	  <br />
	 </fieldset>";
...
$frm[1]="<fieldset>
	  ...
	  <input type=text id=txtnotransaksi size=25 class=myinputtext onkeypress=\"return tanpa_kutip(event);\" maxlength=17>
