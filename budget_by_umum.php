...
//pilihan kodebudget
    $str="select kodebudget,nama from ".$dbname.".bgt_kode
        where kodebudget like 'UMUM%' or kodebudget like 'PENJUALAN%';
        ";
    $optkodebudget="";
    $res=mysql_query($str);
...
//pilihan kodeakun    
  ...
  $optVhc="";
  $str="select kodevhc from ".$dbname.".vhc_5master order by kodevhc";
  $res=mysql_query($str);
  while($bar=mysql_fetch_object($res))
  {
...
<div style=overflow:auto;width:100%;height:300px; id=container0>";
    ...
    $str="select * from ".$dbname.".bgt_budget
        where kodebudget in ('UMUM','PENJUALAN') and tipebudget = '".$tipebudget."' and kodeorg = '".$kodeorg."'
...
//        where kodeorg = '".$mesin."' and kodeorg like '".substr($_SESSION['empl']['lokasitugas'],0,4)."%'";
    $str="select a.*, b.tutup from ".$dbname.".bgt_budget_detail a
        ...
        where a.kodebudget in ('UMUM','PENJUALAN') and a.tipebudget = '".$tipebudget."' and a.kodeorg = '".$kodeorg."'
