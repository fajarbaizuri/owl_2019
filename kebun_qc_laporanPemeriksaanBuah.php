...
<legend><b>Pemeriksaan Buah</b></legend>
...
<tr><td colspan=\"2\">
<button onclick=\"zPreview('kebun_slave_qc_laporanPemeriksaanBuah','".$arr."','printContainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Preview</button>
<button onclick=\"zPdf('kebun_slave_qc_laporanPemeriksaanBuah','".$arr."','printContainer')\" class=\"mybutton\">PDF</button>    
<button onclick=\"zExcel(event,'kebun_slave_qc_laporanPemeriksaanBuah.php','".$arr."')\" class=\"mybutton\" name=\"preview\" id=\"preview\">Excel</button></td></tr>
