...
while($rSensus=mysql_fetch_assoc($qPotensi))
{
      ...
      @$potProd[$rSensus['tahuntanam']]=(($lsRealisasi[$rSensus['tahuntanam']]*$rPot['kgproduksi'])/1000)/$lsRealisasi[$rSensus['tahuntanam']];
}
...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=8 align=left><b>Produksi Ton/Ha</b></td><td colspan=3 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
	...
	<tr>
        ...
        $tab.="<tr><td ".$bgcoloraja." >ANGGR</td><td ".$bgcoloraja." >REAL</td><td ".$bgcoloraja." >SETAHUN</td><td ".$bgcoloraja." >BI</td>
