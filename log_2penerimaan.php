...
echo"<table>
	 ...
	 <td><fieldset><legend>".$_SESSION['lang']['carinopo']."</legend>"; 
                        echo $_SESSION['lang']['pilihgudang'].":<select id=kdGdng>".$optGudang."</select>&nbsp;";
			echo $_SESSION['lang']['nopo'].":<input type=text id=txtsearch size=25 maxlength=30 class=myinputtext onkeypress='return tanpa_kutip(event)'>&nbsp;";
			echo $_SESSION['lang']['namabarang'].":<input type=text class=myinputtext id=nmBrg onkeypress='return tanpa_kutip(event)' />&nbsp;";
