...
$nmPrshn="Holding";
$sData="select distinct substr(kodebudget,3,3) as kelompokbarang from ".$dbname.".bgt_budget_detail where kodebudget like 'M%' or kodebudget like 'S-%' order by substr(kodebudget,3,3) asc";
...
if($kdPt!=''&&$kdUnit=='')
{
        $where.= " and substr(kodebudget,1,1) in ('M','S') and substr(kodeorg,1,4) in (select distinct kodeorganisasi from ".$dbname.".organisasi where induk='".$kdPt."')";
        $nmPrshn=$optNmOrg[$kdPt];
}
if($kdUnit!='')
{		
		if (substr($kdUnit,3,1)=="M"){
			$where.=" and substr(kodebudget,1,1) in ('S') and substr(kodeorg,1,4)='".$kdUnit."'";
		}else if (substr($kdUnit,3,1)=="E"){
			$where.=" and substr(kodebudget,1,1) in ('M') and substr(kodeorg,1,4)='".$kdUnit."'";
		}else{
			$where.=" and substr(kodebudget,1,1) in ('M','S') and substr(kodeorg,1,4)='".$kdUnit."'";
		}
...
$sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(fis01) as fis1,sum(fis02) as fis2,
            ...
            sum(fis10) as fis10,sum(fis11) as fis11,sum(fis12) as fis12,sum(jumlah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where substr(kodebudget,1,1)='M' or substr(kodebudget,1,1)='S' ".$where."
            group by kodebarang";
			*/
			$sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(fis01) as fis1,sum(fis02) as fis2,
            sum(fis03) as fis3,sum(fis04) as fis4,sum(fis05) as fis5,sum(fis06) as fis6,sum(fis07) as fis7,sum(fis08) as fis8,sum(fis09) as fis9,
            sum(fis10) as fis10,sum(fis11) as fis11,sum(fis12) as fis12,sum(jumlah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where  ".$where."
            group by kodebarang";
}
else
{
    ...
    $sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(rp01) as fis1,sum(rp02) as fis2,
            ...
            sum(rp10) as fis10,sum(rp11) as fis11,sum(rp12) as fis12,sum(rupiah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where substr(kodebudget,1,1)='M' or substr(kodebudget,1,1)='S' ".$where."
            group by kodebarang";
			*/
			 $sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(rp01) as fis1,sum(rp02) as fis2,
            sum(rp03) as fis3,sum(rp04) as fis4,sum(rp05) as fis5,sum(rp06) as fis6,sum(rp07) as fis7,sum(rp08) as fis8,sum(rp09) as fis9,
            sum(rp10) as fis10,sum(rp11) as fis11,sum(rp12) as fis12,sum(rupiah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where  ".$where."
            group by kodebarang";
}
//echo $sListData;
