...
echo "
<div style=\"background-image:url(images/menu/center_tile_skyblue.gif)\">
...
$res_m1=mysql_query($str_m1);
	...
	{
		$master_id=$bar_m1->id;
		echo"<li><a class=\"qmparent\" href=\"javascript:void(0)\">".strtoupper($bar_m1->caption)."</a>";
		//=======================================================	
					...
					if($bar_m2->class=='devider')
					  ...
					  echo"<li><span class=\"qmtitle\" >".$bar_m2->caption."</span></li>";
				    else 
						{
							...
							{				
							 echo "<li><a class=\"qmparent\" href=\"javascript:void(0);\"><img src=images/menu/star.png style='border:0px;vertical-align:middle;height:11px'> ".$bar_m2->caption."  ".$arrow_location."</a>";	
							     //===============================================
										...
										if($bar_m3->class=='devider')
										  ...
										  echo"<li><span class=\"qmtitle\" >".$bar_m3->caption."</span></li>";
									    else 
											{
												...
												{
												echo "<li><a class=\"qmparent\" href=\"javascript:void(0);\"><img src=images/menu/star.png style='border:0px;vertical-align:middle;height:11px'> ".$bar_m3->caption."  ".$arrow_location."</a>";	
												     //===============================================
