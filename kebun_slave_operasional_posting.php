...
$selisihpost=number_format((float)$totalHk - $hkPres, 2, '.', '');

//exit("Error:$selisihpost");

#=== Cek if HK belum sama ===
//if(empty($dataAbs) or ($totalHk!=$hkPres)) {
if(empty($dataAbs) or ($selisihpost != 0.00)) {
    echo 'Warning : HK Prestasi belum teralokasi dengan lengkap'.$selisihpost;
    exit;
}
