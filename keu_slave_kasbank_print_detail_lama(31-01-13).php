...
case'html':
	...
	/*PDF LAMA COIIIIIIIIIIIIIIII update pdf html by ind
...
case'pdf':
		...
		if($kodepemisah=='FBHO')
		{	
			$pdf->Cell(45,30,'Diajukan',1,0,'C',1);		
			$pdf->Cell(95,15,'Diperiksa',1,0,'C',1);
			$pdf->Cell(115,15,'Disetujui Pejabat Berwenang',1,0,'C',1);	
			//$pdf->Cell(115,15,'Disetujui Pejabat Berwenang',1,0,'C',1);
			$pdf->Cell(45,30,'Posting',1,0,'C',1);
			$pdf->Ln(15);
			$pdf->SetX(73.5);	
			$pdf->Cell(45,15,'Spv. Keu',1,0,'C',1);		
			$pdf->Cell(49.75,15,'Mgr. Keu',1,0,'C',1);
			$pdf->Cell(57.5,15,'Direktur',1,0,'C',1);
			$pdf->Cell(57.5,15,'Direktur Utama',1,0,'C',1);
			$pdf->SetX(485);
			$pdf->Cell(1,15,'(..........................................................................)',0,1,'C',1);	
		}	
		else
		{
			$pdf->Cell(45,30,'Diajukan',1,0,'C',1);		
			$pdf->Cell(95,15,'Diperiksa',1,0,'C',1);
			$pdf->Cell(115,30,'Disetujui Pejabat Berwenang',1,0,'C',1);	
			//$pdf->Cell(115,15,'Disetujui Pejabat Berwenang',1,0,'C',1);
			$pdf->Cell(45,30,'Posting',1,0,'C',1);
			$pdf->Ln(15);
			$pdf->SetX(73.5);	
			...
			$pdf->Cell(45,98,'',1,0,'C',1);		
			$pdf->Cell(45,98,'',1,0,'C',1);	
			$pdf->Cell(49.75,98,'',1,0,'C',1);
		if ($kodepemisah=='FBHO')
		{		
			$pdf->Cell(57.5,98,'',1,0,'C',1);	
			$pdf->Cell(57.5,98,'',1,0,'C',1);	
		}
		else
		{
			$pdf->Cell(115.5,98,'',1,0,'C',1);	
		}
			$pdf->Cell(44.75,98,'',1,0,'C',1);	
			...
			$pdf->SetX(485);
			$pdf->Cell(1,15,'Penerima / Penyetor',0,1,'C',1);
			$pdf->SetX(328);		
			$pdf->Cell(170,15,'Budget',1,0,'C',1);
			$pdf->Cell(70,15,'Paraf',1,0,'C',1);
			$pdf->Ln(15);
			$pdf->SetX(328);
			$pdf->Cell(170,68,'',1,0,'C',1);
			$pdf->Cell(70,68,'',1,0,'C',1);
			
			$pdf->Ln(1);
			$pdf->SetX(330);	
			$pdf->Cell(1,15,'Pos Anggaran No.',0,1,'L',1);
			$pdf->SetX(330);
			$pdf->Cell(1,15,'Sisa Awal Anggaran',0,0,'L',1);
			$pdf->SetX(425);
			$pdf->Cell(1,15,': Rp.',0,1,'L',1);
			$pdf->SetX(330);
			$pdf->Cell(1,15,'Diajukan',0,0,'L',1);
			$pdf->SetX(425);
			$pdf->Cell(1,15,': Rp.',0,1,'L',1);
			$pdf->SetX(330);
			$pdf->Cell(1,15,'Sisa Dapat Dipakai',0,0,'L',1);
			$pdf->SetX(425);
			$pdf->Cell(1,15,': Rp.',0,1,'L',1);
