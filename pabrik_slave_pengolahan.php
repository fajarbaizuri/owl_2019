...
//		    } else {
	...
	# Content
	$cols = "nopengolahan,kodeorg,tanggal,shift";
	...
	$cols = array('kodeorg','tanggal','shift',
	    ...
	    'jamstagnasi','jumlahlori','tbsdiolah','jumlahpress');
...
//    }
	...
	$els[] = array(
	makeElement('jumlahpress','label',"Jumlah Mesin Press"),
	makeElement('jumlahpress','textnum',$data['jumlahpress'],array('style'=>'width:150px'))
    );
    /*$els[] = array(
