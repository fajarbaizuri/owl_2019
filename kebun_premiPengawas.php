...
OPEN_BOX('',$_SESSION['lang']['insentif'].' Pengawas');
...
$strKom="select * from ".$dbname.".sdm_ho_component where id = '16'";	  
...
echo "<div>";
	...
	where a.idkomponen = '16' and  b.lokasitugas = '".$_SESSION['empl']['lokasitugas']."'
