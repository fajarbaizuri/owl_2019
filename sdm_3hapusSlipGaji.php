...
echo"<fieldset style='width:500px;'><legend>Delete Slyp</legend>
    <table>
     ...
     <tr><td>".$_SESSION['lang']['sistemgaji']."</td><td><select id=tipekaryawan><option value='all'>Seluruhnya</option><option value='Bulanan'>Bulanan</option><option value='Harian'>Harian</option></select></td></tr>    
     </table>
