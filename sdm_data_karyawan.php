...
echo"<table>
	 ...
	 if (($_SESSION['standard']['username']=='achmad.rivai' )||($_SESSION['standard']['username']=='hevi.wahyuni' )){  
			echo"<td align=center style='width:100px;cursor:pointer;' onclick=displayFormInput()>
...
echo"</div>";
if (($_SESSION['standard']['username']=='achmad.rivai' )||($_SESSION['standard']['username']=='hevi.wahyuni' )){  
	echo"<div id='searchplace' style='display:none;'>";
}else{
	echo"<div id='searchplace' >";
}
echo"".$_SESSION['lang']['daftarkaryawan']." ".$_SESSION['empl']['lokasitugas'].":<span id=cap1></span>-<span id=cap2></span>
     <br>
