...
*/	   
	 //  $this->SetMargins(15,10,0);
		...
		$this->Cell(60,15,'Fajar Baizury Group',0,1,'L');
                $this->SetTextColor(0,0,0);
...
//  
$paragraf1="Dalam rangka memperoleh hasil guna yang optimum dan sesuai dengan perkembangan perusahaan dewasa ini, dipandang perlu melaksanakan ".$tipesk."  terhadap karyawan lingkungan Fajar Baizury Group.";
 if($pg1!=='')
     $paragraf1=$pg1;
$paragraf2="Terhitung mulai tanggal ".$mulaiberlaku.", perusahaan melakukan ".$tipesk." terhadap saudara/(i):";	

$paragraf3="Jajaran direksi Fajar Baizury Group mengucapkan selamat berkarya.";	

$paragraf25   ="Dalam melaksanakan tugas / jabatan tersebut diatas berada dibawah dan bertanggung jawab kepada ".ucwords(strtolower($atasanbaru))." sebagai ".ucwords(strtolower($jabatanatasan))."  di Fajar Baizury Group";
...
/*	
$paragrafx="Promosi Jabatan dari ".$oldjabatan." menjadi ".$newjabatan." di PT. Perkebunan Minanga Ogan";	
    $pdf->Cell(20,5,'Tentang',0,0,'L');
    $pdf->Cell(5,5,":",0,0,'L');	
	$pdf->SetFont('Arial','I',10);
	$pdf->MultiCell(170,5,$paragrafx,0,'J');
*/	
	$pdf->SetFont('Arial','',10);	
	$pdf->Ln();	
	$pdf->SetX(20);		
