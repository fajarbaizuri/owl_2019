<?php
    ...
    class PDF extends FPDF{
        function Header() {
            ...
            $this->Cell($width,$height, $_SESSION['lang']['periode'].":".$tgl1." S/d ".$tgl2 ." ".$_SESSION['lang']['unit'].":" .($unit!=''?$unit:$_SESSION['lang']['all']),0,1,'C');	
            ...
            foreach($tanggal as $tang){
                ...
                $this->Cell(2.84/100*$width,$height,'hk',BRL,0,'C',1);      
                $this->SetTextColor(0,0,0);
            }
            $this->Cell(4/100*$width,$height,'hk',BRL,0,'C',1);
            $this->Ln();
        }
