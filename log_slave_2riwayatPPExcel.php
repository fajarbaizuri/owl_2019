...
while($bar=mysql_fetch_object($res))
{
	$namapt=strtoupper($bar->namaorganisasi);
		...
		$stream.="<table  cellspacing='1' border='0'>
				...
				<td bgcolor=#DEDEDE align=center>Stok Awal</td>  
...
//					else
					{
						$res['lokalpusat']==0?$npo=$rPo2['nopo']:$npo="PO Lokal";
                                                $dsetujui+=1;
					}
					...
					$stream.="<tr class=rowcontent>
						...
						{
							$stream.="<td>".$barangstok."</td>";
						}						
												
												
						$stream.="<td align=left>".$res['keterangan']."</td>
                                                ";
						$stream.="<td>".$statPp."</td>";
			...
			else
			{
			 ...
			 $stream.="<tr class=rowcontent><td colspan=16 align=left><table cellpadding=1 cellspacing=1 border=1 class=sortable>";
                                ...
                                $stream.="<td  bgcolor=#DEDEDE align=center>Sudah PO</td>";
                                $stream.="<td bgcolor=#DEDEDE align=center>".$_SESSION['lang']['ditolak']."</td>";
                                $stream.="<td bgcolor=#DEDEDE align=center>Menunggu Keputusan</td>";
                                $stream.="<td bgcolor=#DEDEDE align=center>Belum Diajukan</td>";
                                $stream.="<td bgcolor=#DEDEDE align=center>Proses Purchsing</td>";
