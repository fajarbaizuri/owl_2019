...
OPEN_BOX('',"<b>".$_SESSION['lang']['retur'].":</b>");
...
echo"</legend>";
if($_SESSION['org']['tipelokasitugas']=='KANWIL')
...
$frm[0].="<table cellspacing=1 border=0>
	 ...
	 <td>".$_SESSION['lang']['kodebarang']."</td><td><input type=text id=kodebarang class=myinputtext size=25 maxength=11 onkeypress=\"return angka_doang(event);\">
         <td>".$_SESSION['lang']['kodeblok']."</td><td><input type=text id=kodeblok class=myinputtext size=25 maxength=11 onkeypress=\"return tanpakutip_dan_sepasi(event);\">    
