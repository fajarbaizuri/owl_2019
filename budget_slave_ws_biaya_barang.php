<?php
	...
	//$haha=substr($awalan,0,3);LEFT(comments, 25) 
	//$str="select * from ".$dbname.".log_5masterbarang where left('kodebarang',3)='".$awalan."' and (namabarang like '%".$txtfind."%' or kodebarang like '%".$txtfind."%') ";
