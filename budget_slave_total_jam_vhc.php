...
$thnBudgetHead=$_POST['thnBudgetHead'];
$kdVhcHead=$_POST['kdVhcHead'];
//echo $kdVhcHead;
$kdUnitHead=$_POST['kdUnitHead'];
$proses=$_POST['proses'];
	...
	switch($proses)
	{
		...
		break;
                case'cekHead':
                    ...
                    if($dtK!=$dtA)
                    {
                        exit("Error:Format Tahun Tidak Benar");
                    }
...
//                    if($totalSum==0)
//                    {
//                        $porsiJm=$totJamThn/12;
//                        for($a=1;$a<=$totRow;$a++)
//                        {
//                           $_POST['arrJam'][$a]=$porsiJm;
//                        }
//                    }
//                    elseif($totalSum<$totJamThn)
//                    {
//                        for($a=1;$a<=$totRow;$a++)
//                        {
//                           $_POST['arrJam'][$a]=($_POST['arrJam'][$a]/$totalSum)*$totJamThn;
//                        }
//                    }
                    ...
                    {
                        exit("Error:Data Dengan Kodevhc, Tahun Budget dan Kode Uniter Tersebut Sudah Ada");
                    }
                break;
		...
		case'loadData':
                    if($thnBudgetHead!='')
                    {
                        $where5.=" and tahunbudget='".$thnBudgetHead."'";
                    }
                    if($kdVhcHead!='')
                    {
                        $where6.=" and kodevhc='".$kdVhcHead."'";
						//echo $where6;
                    }
                    if($kdUnitHead!='')
                    {
                        $where7.=" and unitalokasi='".$kdUnitHead."'";
                    }
                ...
                $ql2="select count(*) as jmlhrow from ".$dbname.".bgt_vhc_jam where kodetraksi like '%".$_SESSION['empl']['lokasitugas']."%' ".$where5." ".$where6." ".$where7."";// echo $ql2;
                ...
                $sList="select * from ".$dbname.".bgt_vhc_jam 
                    where kodetraksi like '%".$_SESSION['empl']['lokasitugas']."%' ".$where5." ".$where6." ".$where7." order by tahunbudget desc limit ".$offset.",".$limit."";
                //exit("error".$sList);
...
//                $sGet="select jam01, jam02, jam03, jam04, jam05, jam06, jam07, jam08, jam09, jam10, jam11, jam12 from ".$dbname.".bgt_vhc_jam where ".$where." ";
//                $qGet=mysql_query($sGet) or die(mysql_error($conn));
