...
if($proses=='excel')
{
    ...
    $tab.="
    <table>
    <tr><td colspan=5 align=left><b>25.4 TRANSIT ALAT BERAT</b></td><td colspan=7 align=right><b>".$_SESSION['lang']['bulan']." : ".substr(tanggalnormal($periode),1,7)."</b></td></tr>
        ...
        case'pdf':
           ...
           function Header() {
            ...
            global $tot;
                ...
                $this->Cell($width,$height,strtoupper("25.4 TRANSIT ALAT BERAT"),0,1,'L');
